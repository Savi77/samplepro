...
class Notification_model extends CI_Model 
{
    ...
    {
        $where=array('user_status'=>1, 'user_type'=>E);
        $this->db->where($where);
    ...
    public function send_notification($selct_cust_emp,$customer_id1,$emp_id1,$description)
    {
        ...
        {
                $data1 = $this->db->query("SELECT * FROM `tbl_customer` WHERE `delete_status`='1'");
        ...
        {
                $data3 = $this->db->query("SELECT * FROM `tbl_admin_login` WHERE `user_status`='1'");
