   ...
   public function ShareDetails($formdata)
    {
        ...
        $email_config = Array(
               ...
               $msg='<html><table border=0 width=100%>
                          <tbody>
                 ...
                 $msg.='</html>';
                  ...
                  $this->email->to('kedar.adhangale79@gmail.com');
                  $this->email->cc($final_str); 
                  // $this->email->cc('kedar.adhangale79@gmail.com'); 
...
// =================================================
  ...
  public function WelComeEmailSent($lead_main_id)
  {
    ...
    if (empty($emailData)) {
      ...
      echo $html = '<html><body>'.$body_content.'</body></html>';
      $email_config = array(
      ...
      $cc_mail = 'skkingmaker33@gmail.com,ileaftechnology@gmail.com';
      $this->load->library('email', $email_config);
      ...
      if ($_SESSION['org_company_attachment'] != '') {
        $this->email->attach($attachment);
      }
      $this->email->set_mailtype('html');
      if($this->email->send()){
