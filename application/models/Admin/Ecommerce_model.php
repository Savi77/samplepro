...
// ------------------------------------------- Display List of orders ----------------------------
         public function order_list()
         {
            ...
            $data = $this->db->query(" SELECT * FROM `tbl_order` where org_id='$org_id' ORDER BY order_id DESC")->result();
            $order_array=array();
         ...
         public function OrderReport($type)
         {
            ...
            if($type=='Booked')
            {
              $data = $this->db->query("SELECT * FROM `tbl_order` WHERE org_id='$org_id'and  order_status_id='3'  ORDER BY order_id DESC ")->result();
            }
            else if($type=='Processed')
            {
              $data = $this->db->query("SELECT * FROM `tbl_order` WHERE org_id='$org_id' and order_status_id='4'   ORDER BY order_id DESC")->result();
            }
            else if($type=='Shipped')
            {
              $data = $this->db->query("SELECT * FROM `tbl_order`  WHERE org_id='$org_id' and  order_status_id='5'  ORDER BY order_id DESC")->result();
            }
            else if($type=='Completed')
            {
              $data = $this->db->query("SELECT * FROM `tbl_order`  WHERE  org_id='$org_id' and  order_status_id='6'  ORDER BY order_id DESC")->result();
            }
            else if($type=='Canceled')
            {
              $data = $this->db->query("SELECT * FROM `tbl_order`  WHERE  org_id='$org_id' and  order_status_id='7'  ORDER BY order_id DESC")->result();
            }
...
// ------------------------------- Order Status List --------------------------------
         ...
         {
            $org_id=$this->session->org_id;
            return $this->db->query("SELECT order_status_id, name FROM `tbl_order_status` WHERE  status='1' and org_id='$org_id' ")->result();
         }
...
// ------------------------- Order status -----------------------------
    ...
    public function Edit_Add_status($data) 
    {
