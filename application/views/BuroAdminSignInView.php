                  ...
                  <div class="card-title text-center">
                      ...
                      <img src="<?= base_url() ?>app-assets/images/logo/logo_three.png" style="height: 0.6rem;width:16rem;">
								...
								<div class="card-content">
									<p class="card-subtitle line-on-side text-muted text-center font-medium-1 mx-2 my-1"><span>Admin Sign In </span></p>
									<div class="card-body">
        ...
        $("#LoginForm").on('submit',(function(e)
            {
              ...
              else
              {
                ...
                $("#preview3").show();   
                $.ajax({
                  url: '<?php echo base_url('BA/Admin_authentication') ?>',
                  type: "POST",
                  ...
                  success: function(data)
                  {
                    ...
                    if(data==1)
                    {
                        ...
                        window.location="<?php echo base_url('BA/Dashboard/view_dashboard') ?>";
                    } 
                    else
                    {
                      new PNotify({
