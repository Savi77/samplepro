                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="panel " style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6" align="left">
                                      <ul class="list list-unstyled">
                                        <li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_1_reschedule; ?> <br /> <i style="font-size: 10px;">Created on <?= $created_on_3 ?></i> </li>
                                      </ul>
                                    </div>
                                    <div class="col-md-6" align="right">
                                      <ul class="list list-unstyled ">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6" align="left">
                                      <ul class="list list-unstyled">
                                        <li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<?= $reschedule_issue_list[$j]['scheduledatetime']; ?></li>
                                      </ul>
                                    </div>
                                    <div class="col-md-6" align="right" <?= $ChangePriorityClass; ?>>
                                      <ul class="list list-unstyled ">
                            ...
                            <div class="panel-footer">
                              <ul>
                                <li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span class="text-semibold"><?= $reschedule_issue_list[$j]['scheduledatetime']; ?></span></li>
                              </ul>
                              <ul class="pull-right">
                        ...
                        ?>
                          <div class="col-md-6">
                            <div class="panel border-left-lg border-left-success" style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
                                ...
                                <div class="row">
                                  <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                      <div class="col-md-6" align="left">
                                        <ul class="list list-unstyled">
                                          <li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_2_reschedule; ?><br /> <i style="font-size: 10px;">Created on <?= $created_on_4 ?></i></li>
                                        </ul>
                                      </div>
                                      <div class="col-md-6" align="right">
                                        <ul class="list list-unstyled ">
                                    ...
                                    <div class="row">
                                      <div class="col-md-6" align="left">
                                        <ul class="list list-unstyled">
                                          <li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<?= $reschedule_issue_list[$record_cnt_reschedule]['scheduledatetime']; ?></li>
                                        </ul>
                                      </div>
                                      <div class="col-md-6" align="right" <?= $ChangePriorityClass; ?>>
                                        <ul class="list list-unstyled ">
                              ...
                              <div class="panel-footer">
                                <ul>
                                  <li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span class="text-semibold"><?= $reschedule_issue_list[$record_cnt_reschedule]['scheduledatetime']; ?></span></li>
                                </ul>
                                <ul class="pull-right">
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6" align="left">
                                      <ul class="list list-unstyled">
                                        <li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_1_complete; ?><br /> <i style="font-size: 10px;">Created on <?= $created_on_5 ?></i></li>
                                      </ul>
                                    </div>
                                    <div class="col-md-6" align="right">
                                      <ul class="list list-unstyled ">
                  ...
                  <form class="form-horizontal" id="reschedule_form" method="POST" action="<?= base_url(); ?>admin/ScheduleManagement/ResheduleActivitySubmit">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-sm-2" for="email">Schedule Date <span style="color: red;">*</span></label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="schedule_date_edit" name="schedule_date" placeholder="Enter Schedule Date" onchange="getassignedissueResch()">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control" name="schedule_type_id" id="schedule_type_edit" disabled>
                            ...
                            <?php
                            foreach ($schedule_visit_list as $st_value) { ?>
                              <option value="<?= $st_value->id ?>" <?= $st = ($ResheduleActivityData->schedule_type_id == $st_value->id) ? 'selected' : ''; ?>><?= $st_value->type_name ?></option>
                            <?php  } ?>
                          </select>
                        </div>
                      </div>
    ...
    $(document).ready(function(e) {
      $("#reschedule_data_form").on('submit', (function(e) {
        ...
        if (e.isDefaultPrevented()) {
          ...
          $("#loader_gif2").html('<img src="<?= base_url() ?>assets/images/default.gif" style="height:30px;width:30px;" alt="sending data...."/>');
          $("#loader_gif2").show();
    ...
    $(document).ready(function(e) {
      $("#complete_data_form").on('submit', (function(e) {
        ...
        if (e.isDefaultPrevented()) {
          ...
          $("#loader_gif3").html('<img src="<?= base_url() ?>assets/images/default.gif" style="height:30px;width:30px;" alt="sending data...."/>');
          $("#loader_gif3").show();
