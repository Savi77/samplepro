                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Lead | Opportunity by Stage</h5>
                                        </div>
                                        <div class="row">
                                                      ...
                                                      <tbody>
                                                          <?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                  <a title="<?= $row['stage_title'] ?>" onclick="ViewDetails(id)" id="<?= $row['stage_id'] ?>"><b><?= $row['total'] ?></b></a>
                                                                </td> 
