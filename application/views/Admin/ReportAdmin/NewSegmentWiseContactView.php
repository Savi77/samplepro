    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Segment Contacts</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="cust_type" id="cust_type_1" data-placeholder="Select Type">
                        ...
                        <div class="col-lg-6 mt-4" style="text-align:right;">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a rel="tooltip" style="border: 1px solid green;background: green;color: #fff;border-radius: 4px;padding: 1px 8px;" title="View Segment Contacts" onclick="ViewDetails(id)" id="<?= $row['business_id'] ?>"><?= $row['total'] ?></a>
                                        </div>
                                    </td>
                                    <td class="d-none"></td>
                                    <td class="d-none"></td>
