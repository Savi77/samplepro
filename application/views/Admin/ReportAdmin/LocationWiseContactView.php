...
<head>
      ...
      <title> Location wise Contact</title>
    <!-- Global stylesheets -->
    <!-- Global stylesheets -->
                    ...
                    <ul class="list-inline list-inline-condensed no-margin-bottom">    
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url('admin/ReportAdmin/Reports/AllContacts'); ?>">
                                    <i class="icon-file-presentation"></i> All Contacts</a>
                            </li>

                            <li><a href="<?php echo base_url('admin/ReportAdmin/Reports/SegmentWiseContact'); ?>">
                                    <i class="icon-vcard"></i> Segment Wise Contacts</a>
                            </li>
                            ...
                            <li><a href="<?php echo base_url('admin/ReportAdmin/Reports/ContactSummary'); ?>">
                                    <i class="icon-toggle"></i> Contact Summary</a>
                            </li>
                            ...
                            <li><a href="<?php echo base_url('admin/ReportAdmin/Reports/ContactsWithNoActivities'); ?>">
                                    <i class="icon-file-presentation"></i> Contacts with No Activities Details</a>
                            </li>
                       ...
                       <li><a  href="<?php echo base_url('admin/ReportAdmin/Reports/LocationWiseContact');?>" class="btn btn-link btn-sm legitRipple">
                         <i class="icon-map"></i> Location wise Contact</a>
                      </li>
                    </ul>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Location wise Contact</h5>
                                        </div>
                                        <div class="row">
                                                          ...
                                                          <div class="form-group">
                                                              ...
                                                              <div class="col-sm-8">
                                                                  <div class="input-group date">
                                                                     ...
                                                                     <div class="multi-select-full">
                                                                        <select  class="form-control"  name="cust_type" id="customer_type"> 
                                                      ...
                                                      <tbody>
                                                          <?php
                                                            ...
                                                            <tr>
                                                                <td><?= $count; ?></td>
                                                                <td><?= $row['location'] ?></td>
                                                                <td><a  title="Location wise Contact"  onclick="ViewDetails(id)" id="<?= $row['location_id'] ?>"><b><?= $row['total'] ?></b></a></td> 
                                                            </tr>
                                                           <?php $count++;  } ?> 
                                                      </tbody>
                                                    </table>
...
<script type="text/javascript">  
  function ViewDetails(location_id)
  {
      var start_date=$("#start_date").val();
      var end_date=$("#end_date").val();
      var customer_type=$("#customer_type").val();
      
      var datastring='location_id='+location_id+'&start_date='+start_date+'&end_date='+end_date+'&customer_type='+customer_type;
      // alert(datastring);
      $.ajax({
              url: "<?php echo base_url('admin/ReportAdmin/Reports/LocationWiseContactDetails'); ?>",
              type: "POST",
              data: datastring,
           ...
           if (e.isDefaultPrevented())
            ...
            else
            {
                  ...
                  $.ajax({
                    ...
                    url: "<?php echo base_url('admin/ReportAdmin/Reports/DateRangeLocationWiseContact'); ?>",
                    type: "POST",
                    ...
                    success: function(data)
                      {
                        ...
                        //------------------------------------------------------------
                          $.ajax({
                                  url: "<?php echo base_url('admin/ReportAdmin/Reports/DateRangeLocationWiseContactGraph'); ?>",
                                  type: "POST",
                                  data: datanew,
...
Highcharts.chart('container3', {
  ...
  credits:{
   enabled:false,
    ...
    title: {
        text: 'Location wise Contact<br/><p style="font-size:12px;color:#FF5732;"></p>'
    },
    // subtitle: {
    ...
    series: [
        {
            ...
            data: [
                     <?php 
                        foreach ($LocationWiseContact as $Employee) 
                       {
                   ?>
                    {
