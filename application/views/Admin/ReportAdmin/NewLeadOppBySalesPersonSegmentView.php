...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Sales Segment</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="customer_type" id="customer_type_8" data-placeholder="Select Type">
    ...
    <script>
        ...
        function ViewTotalDetails(ids)
        {
            ...
            var customer_type=$("#customer_type_8").val();
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            // //------------------------------------------------
                            // $.ajax({
                            //     url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeLeadOppBySalesPersonSegmentGraph'); ?>",
                            //     type: "POST",
                            //     data: datanew,
