<style>
  table td{
    ...
    /* #ajax_table td:nth-child(2) div a:hover{
        color: #605959 !important;
    } */
    /* #ajax_table td:nth-child(2) div a{
      color: #000 !important;
      font-weight:600
    } */
</style>
<div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
  <h6 class="card-title py-sm-4 card-headings"><?= $FetchAccountOwnersData->name; ?> As Account Manger</h6>
