...
<div class="page-header-content">
  ...
  <div class="page-title">
    <h4>
      ...
      - Lead | Opportunity by Sales Person - Segment wise
    </h4>
  </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Lead | Opportunity by Sales Person - Segment wise</h5>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <table class="table datatable-basic" id="default_issue_table">     
                                                      ...
                                                      <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a title="Lead|Opportunity by Sales Person - Segment wise"  onclick="ViewTotalDetails(id)" id="<?= $row['business_id'].'|'.$row['emp_id'] ?>">
                                                                <b><?= $row['total'] ?></b></a>
                                                                </td>
                                                            </tr>
                                                           <?php $count++;  } ?> 
                                          ...
                                          <div class="col-md-12">
                                            <div class=" panel-body">
                                               <div id="container3" style="min-width: 400px; height: 450px; margin: 0 auto"></div>
                                               </div>
                                            <br/>
                                            <br/>
                                          </div>                                        
...
<script type="text/javascript">
  ...
  function ViewTotalDetails(ids)
  {
      ...
      $.ajax({
                url: "<?php echo base_url('admin/ReportAdmin/Reports/ViewLeadOppBySalesPersonSegment'); ?>",
                type: "POST",
                data: datastring,
           ...
           if (e.isDefaultPrevented())
            ...
            else
            {
                  ...
                  $.ajax({
                    ...
                    url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeLeadOppBySalesPersonSegment'); ?>",
                    type: "POST",
...
Highcharts.chart('container3', {
  ...
  credits:{
   enabled:false,
    ...
    title: {
        text: 'Lead|Opportunity by Sales Person - Segment wise<br/><p style="font-size:12px;color:#FF5732;"></p>'
    },
    // subtitle: {
