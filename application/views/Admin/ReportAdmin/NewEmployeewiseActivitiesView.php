...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Resource Tasks</h6>
            ...
            <!-- <div class="card-body padding-30"> -->
                <form method="post" class="form-horizontal displayFilter" id="get_data_form"  style="display:none;padding:20px;">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <label>Type </label>
                            <select class="form-control" name="customer_type" id="customer_type_15" data-placeholder="Select Type">
                        ...
                        <div class="col-lg-9 text-right mt-4">
                            ...
                            <tr>
                                ...
                                ?>
                                    <td>
                                        ...
                                        <a style="border: 1px solid green;background: green;color: #fff;border-radius: 4px;padding: 1px 8px;" rel="tooltip" title="View Resource Tasks" onclick="ViewDetails(id)" id="<?= $ids ?>"><?= $NewActivityArray[$i]['type_count']; ?></a>
                                        </div>
                                    </td>
                                <?php } ?>
    ...
    <script>
        ...
        function ViewDetails(ids) {
            ...
            var customer_type = $("#customer_type_15").val();
            var datastring = 'ids=' + ids + '&start_date=' + start_date + '&end_date=' + end_date + '&customer_type=' + customer_type;
            // alert(datastring);

            $.ajax({
                url: "<?php echo base_url('admin/ReportAdmin/EmployeeReport/ViewActivitiesDetails'); ?>",
                type: "POST",
                data: datastring,
            ...
            $("#get_data_form").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('admin/ReportAdmin/EmployeeReport/DaterangeEmployeewiseActivities'); ?>",
                        type: "POST",
