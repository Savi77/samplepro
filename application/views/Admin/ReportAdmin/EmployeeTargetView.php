                    ...
                    <ul class="list-inline list-inline-condensed no-margin-bottom">    
                      ...
                      <li class="dropdown">
                        <a href="#" class="btn btn-link btn-sm dropdown-toggle legitRipple" data-toggle="dropdown" aria-expanded="false">
                          <i class="icon-address-book2 position-left"></i> Employee <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                      
                      <li>
                        <a href="<?php echo base_url('admin/ReportAdmin/EmployeeReport/AvailableTimeSlots');?>">
                          <i class="icon-watch"></i> Available Time Slots
                        </a>
                      </li>
                      <li>
                        <a href="<?php echo base_url('admin/ReportAdmin/EmployeeReport/EmployeeTarget');?>">
                          <i class="icon-watch"></i> Employee -Target	
                        </a>
                      </li>
                      <li>
                        <a href="<?php echo base_url('admin/ReportAdmin/EmployeeReport/EmployeeRevenue');?>">
                          <i class="icon-watch"></i> Employee Revenue	
                        </a>
                      </li>
                      <li>
                        <a href="<?php echo base_url('admin/ReportAdmin/EmployeeReport/EmployeewiseActivities');?>">
                          <i class="icon-watch"></i> Employee wise Activity	
                        </a>
                      </li>
                      <li>
                        <a href="<?php echo base_url('admin/ReportAdmin/EmployeeReport/EmployeewiseActivitiesMapping');?>">
                          <i class="icon-watch"></i> Employee wise Activity Mapping	
                        </a>
                      </li>

                    </ul>
                      </li>
                      <li><a  href="<?php echo base_url('admin/ReportAdmin/EmployeeReport/EmployeeTarget');?>" class="btn btn-link btn-sm legitRipple">
                        <i class="icon-target"></i> Employee Target</a>
                      </li>
                    </ul>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Employee Target</h5>
                                        </div>
                                        <div class="row">
                                                          ...
                                                          <div class="form-group">
                                                              ...
                                                              <div class="col-sm-10">
                                                                  <div class="input-group date">
                                                                     ...
                                                                     <div class="multi-select-full">
                                                                        <select  class="multiselect-select-all" multiple="multiple"  name="ActivityArray[]">
                                                                          <?php
                                                                          foreach ($ActivityArray as  $row) 
                                                                          {
                                                                          ?>
                                                                          <option value="<?= $row->targettype_id; ?>"><?= $row->target_type; ?></option>
                                                                        <?php }?>
                                                                        </select>
                                                                      </div>
                                                                  </div>
                                                      ...
                                                      <tbody>
                                                          <?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                  <a title="<?= $row['emp_name'] ?>" onclick="ViewDetails(id)" id="<?= $row['employee_id'] ?>"><b><?= $row['emp_name'] ?></b></a>
                                                                </td> 
           ...
           if (e.isDefaultPrevented())
            ...
            else
            {
                  ...
                  $.ajax({
                    ...
                    url: "<?php echo base_url('admin/ReportAdmin/EmployeeReport/DaterangerEmployeeTarget'); ?>",
                    type: "POST",
