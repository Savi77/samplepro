...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Sales Force Scores</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="customer_type" id="customer_type_6" data-placeholder="Select Type">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="default_issue_table">
                    ...
                    <tbody>
                        <?php
                        $count = 1;
                        foreach ($LeadOppBySalesPerson as $row) {
                        ?>
                            <tr>
                                <td>
                                    <div>
                                ...
                                <td>
                                    ...
                                    <a rel="tooltip" title="View Sales Force Scores"  style="border: 1px solid green;background: green;color: #fff;border-radius: 4px;padding: 1px 8px;" onclick="ViewDetails(id)" id="<?= $row['emp_id'] ?>"><?= $row['total'] ?></a>
                                    </div>
                                </td>
                                <td class="d-none"></td>
                                <td class="d-none"></td>
    ...
    <script>
        ...
        //     title: {
        //         text: 'Leads / Opportunities By Sales Person<br/><p style="font-size:12px;color:#FF5732;"></p>'
        //     },
        //     // subtitle: {
        ...
        function ViewDetails(emp_id) {
            ...
            var customer_type = $("#customer_type_6").val();
            var datastring = 'emp_id=' + emp_id + '&start_date=' + start_date + '&end_date=' + end_date + '&customer_type=' + customer_type;
            // alert(datastring);
            $.ajax({
                url: "<?php echo base_url('admin/ReportAdmin/Reports/ViewSalesPersonDetails'); ?>",
                type: "POST",
                data: datastring,
            ...
            $("#get_data_form").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('admin/ReportAdmin/Reports/DateRangeLeadOppBySalesPerson'); ?>",
                        type: "POST",
                        ...
                        success: function(data) {
                            ...
                            //------------------------------------------------
                            // $.ajax({
                            //     url: "<?php echo base_url('admin/ReportAdmin/Reports/DateRangeLeadOppBySalesPersonGraph'); ?>",
                            //     type: "POST",
                            //     data: datanew,
