...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Account Manger</h6>
    ...
    <script>
        ...
        function ViewDetails(emp_id) {
            ...
            var datastring = 'emp_id=' + emp_id + '&start_date=' + start_date + '&end_date=' + end_date;
            ...
            $("#get_data_form").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('admin/ReportAdmin/Reports/DateRangeAccountOwners'); ?>",
                        type: "POST",
