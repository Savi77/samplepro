...
<head>
	...
	<title>Lead | Opportunity by Segements</title>
	<!-- Global stylesheets -->
	<!-- Global stylesheets -->
	...
	<script type="text/javascript" src="<?= base_url() ?>assets/admin/assets/js/plugins/forms/styling/switch.min.js">
	</script>
	...
	<script type="text/javascript"
		src="<?= base_url() ?>assets/admin/assets/js/plugins/tables/datatables/extensions/jszip/jszip.min.js"></script>
	<script type="text/javascript"
		src="<?= base_url() ?>assets/admin/assets/js/plugins/tables/datatables/extensions/pdfmake/pdfmake.min.js"></script>
	<script type="text/javascript"
		src="<?= base_url() ?>assets/admin/assets/js/plugins/tables/datatables/extensions/pdfmake/vfs_fonts.min.js">
	</script>
	<script type="text/javascript"
		src="<?= base_url() ?>assets/admin/assets/js/plugins/tables/datatables/extensions/buttons.min.js"></script>
						...
						<div class="col-md-12">
							<div class="panel panel-flat">
								<div class="panel-heading table_header">
									<h5 class="panel-title" style="color:white">Lead | Opportunity by Segements</h5>
								</div>
													...
													<div class="col-sm-10">
														<div class="input-group date">
															...
															<input type="text" class="form-control" name="start_date" id="start_date"
																placeholder="Please select start date" autocomplete="off" value="<?= date('01 M Y');?>">
														</div>
													</div>
												</div>
											</div>
														...
														<div class="input-group date">
															...
															<div class="multi-select-full">
																<select class="form-control" name="customer_type" id="customer_type">
																	<option value="All" selected>Lead Type</option>
										...
										<table class="table" id="default_issue_table">
											...
											<tbody>
												...
												<tr>
													...
													<td><a title="Lead | Opportunity by Segements" onclick="ViewDetails(id)"
															id="<?= $row['business_id'] ?>">
															<b><?= $row['total'] ?></b></a>
													</td>
												</tr>
...
<script type="text/javascript">
	function ViewDetails(business_id) {
		...
		// alert(datastring);
		$.ajax({
			url: "<?php echo base_url('admin/ReportAdmin/Reports/ViewBusinessDetails'); ?>",
			type: "POST",
			data: datastring,
		...
		$("#get_data_form").on('submit', (function (e) {
			...
			if (e.isDefaultPrevented()) {
				...
				$.ajax({
					...
					url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeLeadOppBySegments'); ?>",
					type: "POST",
					...
					success: function (data) {
						...
						//------------------------------------------------
						$.ajax({
							url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeLeadOppBySegmentsGraph'); ?>",
							type: "POST",
							data: datanew,
...
<script type="text/javascript">
	...
	Highcharts.chart('container3', {
		...
		title: {
			text: 'Leads/Opportunities by Segements<br/><p style="font-size:12px;color:#FF5732;"></p>'
		},
		// subtitle: {
		...
		series: [{
			...
			data: [ <
				? php
				foreach($Lead_Opportunity_by_Segments as $Employee) {
					?
					> {
						name: '<?= $Employee['
						business_name ']; ?>',
