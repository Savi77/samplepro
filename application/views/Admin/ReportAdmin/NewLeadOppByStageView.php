    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Stage Leads</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="customer_type" id="customer_type_7" data-placeholder="Select Type">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="multiselect-select-all" multiple="multiple" style="display: none;" name="StageArray[]">
                                    <?php foreach ($StageArray as  $row) { ?> <div class="col-sm-1 mt-4 text-right">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a rel="tooltip" style="border: 1px solid green;background: green;color: #fff;border-radius: 4px;padding: 1px 8px;" title="View Stage Leads" onclick="ViewDetails(id)" id="<?= $row['stage_id'] ?>"><?= $row['total'] ?></a>
                                    </div>
                                </td>
                                <td class="d-none"></td>
                                <td class="d-none"></td>
    ...
    <script>
        ...
        function plotgraph(json) {
            Highcharts.chart('container3', {
                ...
                title: {
                    text: 'Stage Leads<br/><p style="font-size:12px;color:#FF5732;"></p>'
                },
                // subtitle: {
                //     text: 'Click the columns to view versions. Source: <a href="http://statcounter.com" target="_blank">statcounter.com</a>'
                // },
        ...
        function ViewDetails(stage_id) {
            ...
            var customer_type = $("#customer_type_7").val();
            var datastring = 'stage_id=' + stage_id + '&start_date=' + start_date + '&end_date=' + end_date + '&customer_type=' + customer_type;
            // alert(datastring);

            $.ajax({
                url: "<?php echo base_url('admin/ReportAdmin/Reports/ViewStageDetails'); ?>",
                type: "POST",
                data: datastring,
            ...
            $("#get_data_form").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('admin/ReportAdmin/Reports/DateRangeLeadOppByStage'); ?>",
                        type: "POST",
                        ...
                        success: function(data) {
                            ...
                            //------------------------------------------------
                            // $.ajax({
                            //     url: "<?php echo base_url('admin/ReportAdmin/Reports/DateRangeLeadOppByStageGraph'); ?>",
                            //     type: "POST",
                            //     data: datanew,
