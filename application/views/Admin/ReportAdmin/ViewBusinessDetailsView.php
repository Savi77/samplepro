...
<div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
    <h6 class="card-title py-sm-4 card-headings">&nbsp;Segment Leads For <?= $GetBusinessDetails->business_name; ?></h6>
                      ...
                      <td>
                        ...
                        <td>
                          <div style="width:150px;">
                            <a rel="tooltip" title="View Leads / Opportunities Details" target="_blank" href="<?= base_url('admin/Leads/ViewDetails')?>?leadopp_id=<?= $row['lead_id']?>"  style="color:#000;font-weight:600;">
                            <?= $row['leadopp_id'] ?>
                          </a>
                          </div>
                        </td>
