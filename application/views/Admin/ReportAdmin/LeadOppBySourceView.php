...
<head>
	...
	<script type="text/javascript"
		src="<?= base_url() ?>assets/admin/assets/js/plugins/tables/datatables/extensions/pdfmake/pdfmake.min.js">
	</script>
	<script type="text/javascript"
						...
						<div class="col-md-12">
							<div class="panel panel-flat">
								<div class="panel-heading table_header">
									<h5 class="panel-title" style="color:white">Lead | Opportunity by Source</h5>
								</div>
								<div class="row">
													...
													<div class="col-sm-10">
														<div class="input-group date">
															...
															<input type="text" class="form-control" name="start_date"
																id="start_date" placeholder="Please select start date"
													...
													<div class="col-sm-10">
														<div class="input-group date">
															...
															<input type="text" class="form-control" name="end_date"
																id="end_date" placeholder="Please select end date"
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<div class="input-group date">
															<span class="input-group-addon"><i
																	class="icon-shrink3"></i></span>
															<div class="multi-select-full">
																<select class="multiselect-select-all"
																	multiple="multiple" name="sourceArray[]">
																	<?php
                                                                          foreach ($SourceArray as  $row) 
                                                                          {
                                                                          ?>
																			<option value="<?= $row->source_id; ?>">
																			<?= $row->source_title; ?></option>
																	<?php }?>
																</select>
															</div>
														</div>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<div class="input-group date">
															<span class="input-group-addon"><i
																	class="icon-hour-glass"></i></span>
															<div class="multi-select-full">
																<select class="multiselect-select-all"
																	multiple="multiple" name="StageArray[]">
																	<?php
                                                                          foreach ($StageArray as  $row) 
                                                                          {
                                                                          ?>
																	<option value="<?= $row->stage_id; ?>">
																		<?= $row->stage_title; ?></option>
																	<?php }?>
																</select>
															</div>
														</div>
									...
									<div class="col-md-12">
										<hr
											style="border: 1px solid #2912121a;margin-top: -5px;margin-bottom: -20px;" />
										<table class="table datatable-basic" id="default_issue_table">
											...
											<tbody>
												...
												<tr>
													...
													<td><?= $row['source'] ?></td>
													<td><a title="Lead | Opportunity by Source"
															onclick="ViewTotalDetails(id)"
															id="<?= $row['source_id'] ?>">
															<b><?= $row['total'] ?></b></a>
													</td>
									...
									<div class="col-md-12">
										<div class=" panel-body">
											<div id="container3"
												style="min-width: 400px; height: 350px; margin: 0 auto"></div>
										</div>
										<br />
										<br />
									</div>
...
<script type="text/javascript">
	...
	Highcharts.chart('container3', {
		...
		series: [{
			name: "Source",
			colorByPoint: true,
			data: [ <?php foreach($Lead_Opportunity_by_Source as $Employee) { ?>
					{
						name: '<?= $Employee['
						source ']; ?>',
						y: <?= $Employee['total']; ?>
