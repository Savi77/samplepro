...
<head>
      ...
      <title>Account wise Revenue</title>
    <!-- Global stylesheets -->
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Account wise Revenue</h5>
                                        </div>
                                        <div class="row">
                                                          ...
                                                          <?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row['company_name'] ?></td>
                                                                 <td><a title="Account Revenue"  onclick="ViewDetails(id)" id="<?= $row['company_id'] ?>">
                                                                  <b><?= $row['revenue'] ?></b></a>
                                                                </td>
                                                            </tr>
                                                           <?php $count++;  } ?> 
