...
<head>
      ...
      <title> Lead | Opportunity by Sales Person</title>
    <!-- Global stylesheets -->
    <!-- Global stylesheets -->
							...
							<div class="page-header-content">
								...
								<div class="page-title">
									<h4>
										...
										- Lead | Opportunity by Sales Person
									</h4>
								</div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Lead | Opportunity by Sales Person</h5>
                                        </div>
                                        <div class="row">
