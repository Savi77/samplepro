...
<head>
      ...
      <title>Lead | Opportunity by Product / Services</title>
    <!-- Global stylesheets -->
							...
							<div class="page-header-content">
								...
								<div class="page-title">
									<h4>
										...
										- Lead | Opportunity by Product / Services
									</h4>
								</div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Lead | Opportunity by Product / Services</h5>
                                        </div>
                                        <div class="row">
           ...
           if (e.isDefaultPrevented())
            ...
            else
            {
                  ...
                  $.ajax({
                    ...
                    url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeLeadOppByProduct'); ?>",
                    type: "POST",
                    ...
                    success: function(data)
                      {
                          ...
                          //------------------------------------------------
                          $.ajax({
                                  url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeLeadOppByProductGraph'); ?>",
                                  type: "POST",
                                  data: datanew,
...
Highcharts.chart('container3', {
  ...
  credits:{
   enabled:false,
    ...
    title: {
        text: 'Leads/Opportunities by Product / Services<br/><p style="font-size:12px;color:#FF5732;"></p>'
    },
    // subtitle: {
    ...
    series: [
        {
            ...
            data: [
                     <?php 
                        foreach ($LeadsByProductSummary as $Employee) 
                       {
                   ?>
                    {
                        name: '<?= $Employee['name']; ?>',
