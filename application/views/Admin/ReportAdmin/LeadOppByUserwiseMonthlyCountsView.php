                    ...
                    <ul class="list-inline list-inline-condensed no-margin-bottom">    
                      ...
                      <li class="dropdown">
                        <a href="#" class="btn btn-link btn-sm dropdown-toggle legitRipple" data-toggle="dropdown" aria-expanded="false">
                          <i class="icon-address-book2 position-left"></i> CRM <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                         
                          <li>
                            <a  href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppBySource');?>">
                              <i class="icon-shrink3"></i> Lead | Opportunity by Source
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppBySegments');?>">
                              <i class="icon-cube3"></i> Lead | Opportunity by Segments
                            </a>
                          </li>

                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppByProduct');?>">
                              <i class=" icon-lifebuoy"></i> Lead | Opportunity by Product
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppByMonthlyCounts');?>">
                              <i class=" icon-lifebuoy"></i> Lead | Opportunity by Monthly Counts
                            </a>
                          </li>
                          
                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppBySalesPerson');?>">
                              <i class=" icon-lifebuoy"></i> Lead | Opportunity by Sales Person
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppByStage');?>">
                              <i class=" icon-lifebuoy"></i> Lead | Opportunity by Stage
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppByUserwiseMonthlyCounts');?>">
                              <i class=" icon-lifebuoy"></i> Lead | Opportunity by Userwise Monthly Count
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppBySalesPersonSegment');?>">
                              <i class=" icon-lifebuoy"></i> Lead | Opportunity by Sales Person -Segment wise
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppBySalesPersonProduct');?>">
                              <i class=" icon-lifebuoy"></i> Lead | Opportunity by Sales Person -Product wise
                            </a>
                          </li>
                          
                        </ul>
                      </li>
                      <li><a  href="<?php echo base_url('admin/ReportAdmin/Reports/LeadOppByUserwiseMonthlyCounts');?>" class="btn btn-link btn-sm legitRipple">
                        <i class="icon-calendar"></i> Lead | Opportunity - Userwise Monthly Counts</a>
                      </li>
                    </ul>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Lead | Opportunity - Userwise Monthly Counts</h5>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <table class="table datatable-basic" id="default_issue_table">     
                                                      ...
                                                      <tbody>
                                                              <?php
                                                                ...
                                                                ?>
                                                            <tr>
                                                                <td> <?= $LeadOppByUserwiseMonthlyCounts[$c]['emp_name'];?> </td>                                                        
                                                               <?php
                                                               ...
                                                               ?>
                                                                      <td>
                                                                        <a  onclick="ViewDetails(id)" id="<?= $montharray[$b]['month'].'|'.$montharray[$b]['year'].'|'.$LeadOppByUserwiseMonthlyCounts[$c]['emp_id'];?>"><b>  </b></a>
                                                                      </td>
                                                             <?php }  ?>
                                                           </tr>
                                                         <?php } ?>
