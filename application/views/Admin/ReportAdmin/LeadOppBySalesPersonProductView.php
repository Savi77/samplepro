							...
							<div class="page-header-content">
								...
								<div class="page-title">
									<h4>
										...
										- Lead | Opportunity by Sales Person - Product wise
									</h4>
								</div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Lead | Opportunity by Sales Person - Product wise</h5>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <table class="table datatable-basic" id="default_issue_table">     
                                                      ...
                                                      <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a title="Lead|Opportunity by Sales Person - Segment wise"  onclick="ViewTotalDetails(id)" id="<?= $row['product_id'].'|'.$row['emp_id'] ?>">
                                                                <b><?= $row['total'] ?></b></a>
                                                                </td>
                                                            </tr>
                                                           <?php $count++;  } ?> 
