            ...
            - Available Time Slots
                                    ...
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Available Time Slots</h5>
                                        </div>
                                        <div class="row">
                                               <div class="col-md-12" id="all_activity_filter" style="margin-top: 10px;">                  
                                                   <form method="post" class="form-horizontal" id="get_data_form">
                                                        ...
                                                        <div class="col-md-2 clockpicker" data-placement="right" data-align="top" data-autoclose="true">
                                                          <div class="form-group">
                                                              <label class="col-sm-3 control-label">From:<span style="color: red;">*</span></label>
                                                              <div class="col-sm-9">
                                                                  <div class="input-group date">
                                                                      <span class="input-group-addon"><i class="icon-watch"></i></span>
                                                                      <input type="text" class="form-control" id="start_time" name="start_time" autocomplete="off" value="00:00">
                                                                  </div>
                                                              </div>
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 clockpicker" data-placement="right" data-align="top" data-autoclose="true">
                                                          <div class="form-group">
                                                              ...
                                                              <div class="col-sm-9">
                                                                  <div class="input-group date">
                                                                      <span class="input-group-addon"><i class="icon-watch"></i></span>
                                                                      <input type="text" class="form-control" name="end_time" id="end_time"  autocomplete="off" value="<?= date("H:i") ?>" >
                                                                  </div>
                                                              </div>
                                                          </div>
                                                        </div>
