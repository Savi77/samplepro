...
<?php
  ...
  // echo "<pre>";
  // print_r($explode[0]);
  $segment_name = $this->db->select('business_name')->from('tbl_business')->where('business_id',$explode[0])->where('org_id',$this->session->org_id)->get()->row()->business_name;
  ?>
<div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
    <h6 class="card-title py-sm-4 card-headings">&nbsp;Sales Segment Of <?= $ViewDetails[0]['assign_to'] . ' For ' . $segment_name ?>  </h6>
