...
<head>
      ...
      <title>Contacts with Activities Details</title>
...
<div class="page-header-content">
    ...
    <div class="page-title">
        <h4>
            ...
            - Contacts with Activities Details
        </h4>
    </div>
                                    ...
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Contacts with Activities Details</h5>
                                        </div>
                                        <div class="row">
                                                      ...
                                                      <tbody>
                                                          <?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a  title="Location wise Contact"  onclick="ViewTotalActivityDetails(id)" id="<?= $row['customer_id'] ?>"><b><?= $row['total_activity'] ?></b></a></td> 
                                                            </tr>
                                                           <?php $count++;  } ?> 
                                                      </tbody>
                                                    </table>
