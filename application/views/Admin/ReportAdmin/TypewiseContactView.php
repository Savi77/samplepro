            ...
            - Type wise Contact
                                    ...
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Type wise Contact</h5>
                                        </div>
                                        <div class="row">
                                               <div class="col-md-12" id="all_activity_filter" style="margin-top: 10px;">    <form method="post" class="form-horizontal" id="get_data_form">   
                                                        <div class="col-md-4">
                                                          <div class="form-group">
                                                              <label class="col-sm-2 control-label">Type :</label>
                                                              <div class="col-sm-10">
                                                                  <div class="input-group date">
                                                                      <span class="input-group-addon"><i class="icon-toggle"></i></span>   
                                                      ...
                                                      <tbody>
                                                          <?php
                                                            ...
                                                            <tr>
                                                                <td><?= $count; ?></td>
                                                                <td><?= $row['title'] ?></td>
                                                                <td><a  title="Type wise Contact"  onclick="ViewDetails(id)" id="<?= $row['type_id'] ?>"><b><?= $row['total'] ?></b></a></td> 
                                                            </tr>
                                                           <?php $count++;  } ?> 
                                                      </tbody>
                                                    </table>
                                          ...
                                          <div class="col-md-12">
                                              <div class=" panel-body">
                                                 ...
                                                 <div id="container4" style="min-width: 400px; height: 350px; margin: 0 auto"></div>
...
<script type="text/javascript">  
  function ViewDetails(type_id)
  {
      ...
      var datastring='type_id='+type_id+'&start_date='+start_date+'&end_date='+end_date;
      // alert(datastring);
      $.ajax({
