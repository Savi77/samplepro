...
<style>
    ...
    #default_issue_table td:nth-child(2) div {
        font-weight: 400 !important;
    }
    .multiselect {
...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Branch</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="customer_type" id="customer_type_10" data-placeholder="Select Type">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="default_issue_table">
                    ...
                    <tbody>
                        <?php
                        $count = 1;
                        foreach ($get_branch_report->result() as $row) {
                        ?>
                            <tr>
                                <td>
                                    <div>
                                ...
                                <td>
                                    <div style="width:150px;">
                                        <a style="border: 1px solid green;background: green;color: #fff;border-radius: 4px;padding: 1px 8px;" rel="tooltip" title="View Branch" onclick="ViewTotalDetails(id)" id="<?= $row->bname ?>">
                                        <?= $row->bcount ?></a>
                                    </div></td>
                                <td>
                                    <div style="width:150px;">
    ...
    <script>
        ...
        Highcharts.chart('container3', {
            ...
            series: [{
                ...
                data: [
                    ...
                    foreach ($get_branch_report->result() as $Employee) {
                    ?> {
                            name: '<?= $Employee->bname;?>',
                            y: <?= $Employee->bcount; ?>
                            // drilldown: "Chrome"
        ...
        function ViewTotalDetails(name) {
            var cust_type = $('#customer_type_10').val();
            var datastring = 'name=' + name + '&& cust_type=' + cust_type;
            // alert(datastring);

            $.ajax({
                url: "<?php echo base_url('admin/ReportAdmin/Reports/Viewbranchtotal'); ?>",
                type: "POST",
                data: datastring,
            ...
            $("#get_data_form").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeBranch'); ?>",
                        type: "POST",
