...
<head>
      ...
      <title>Contacts with No Activities Details</title>
...
<div class="page-header-content">
    ...
    <div class="page-title">
        <h4>
            ...
            - Contacts with No Activities Details
        </h4>
    </div>
                                    ...
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Contacts with No Activities Details</h5>
                                        </div>
                                        <div class="row">
