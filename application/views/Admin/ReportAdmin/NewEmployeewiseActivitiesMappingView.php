...
<style>
    ...
    #default_issue_table_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(1){
        display: none;
    }
    .multiselect {
...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Task Mapping </h6>
            ...
            <!-- <div class="card-body padding-30"> -->
                <form method="post" class="form-horizontal displayFilter" id="get_data_form" style="display:none;padding:20px;">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <label>Type </label>
                            <select class="form-control" name="customer_type" id="customer_type_16" data-placeholder="Select Type">
    ...
    <script>
        ...
        function ViewDetails(stage_id) {
            ...
            var customer_type = $("#customer_type_16").val();
            ...
            $("#get_data_form").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url('admin/ReportAdmin/EmployeeReport/DateRangeEmployeewiseActivitiesMapping'); ?>",
                        type: "POST",
