...
<style>
    ...
    #default_issue_table_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(3){
        display: none;
    }
    .multiselect {
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Resource Target </h6>
                        ...
                        foreach ($EmployeeTarget as $row) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a rel="tooltip" title="View Resource Target" onclick="ViewDetails(id)" id="<?= $row['employee_id'] ?>"><?= $row['emp_name'] ?></a> -->
                                    <?= $row['emp_name'] ?>
                                    </div>
                                </td>
                                <td>
