...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Product Leads </h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="customer_type" id="customer_type_3" data-placeholder="Select Type">
    ...
    <table id="datatable" style="display:none;">
        ...
        <tbody>
        <?php 
            foreach ($LeadsByProductSummary as $row) 
            {
    ...
    <script>
        ...
        function ViewDetails(product_id) {
            ...
            var customer_type = $("#customer_type_3").val();
