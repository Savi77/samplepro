...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Segment Leads</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="customer_type" id="customer_type_2" data-placeholder="Select Type">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="width: 150px;">
                                        <a rel="tooltip" title="View Segment Leads" onclick="ViewDetails(id)" id="<?= $row['business_id'] ?>" style="border: 1px solid green;background: green;color: #fff;border-radius: 4px;padding: 1px 8px;">
                                        <?= $row['total'] ?></a>
                                    </div>
                                </td>
                                <td class="d-none"></td>
    ...
    // $('#myTable').dataTable();
        ...
        //     title: {
        //         text: 'Leads / Opportunities By Segments<br/><p style="font-size:12px;color:#FF5732;"></p>'
        //     },
        //     // subtitle: {
        ...
        function ViewDetails(business_id) {
            ...
            var customer_type = $("#customer_type_2").val();
