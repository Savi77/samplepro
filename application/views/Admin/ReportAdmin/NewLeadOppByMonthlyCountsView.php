...
<style>
    ...
    #default_issue_table_wrapper button.dt-button.buttons-columnVisibility.active:nth-last-child(1),#default_issue_table_wrapper button.dt-button.buttons-columnVisibility.active:nth-last-child(2),#default_issue_table_wrapper button.dt-button.buttons-columnVisibility.active:nth-last-child(3),#default_issue_table_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(4){
    ...
    #default_issue_table td:nth-child(2) div a {
        color: #fff !important;
        /* font-weight: 600; */
    }
    .multiselect {
...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="min-height: unset;">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                <h6 class="card-title py-sm-4 card-headings">Monthly Leads </h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="customer_type" id="customer_type_4" data-placeholder="Select Type">
                            ...
                            <tr>
                                ...
                                ?>
                                    <td>
                                        ...
                                        <a style="border: 1px solid green;background: green;color: #fff;border-radius: 4px;padding: 1px 8px;" rel="tooltip" title="View Monthly Leads" onclick="ViewDetails(id)" id="<?= $array[$b]['month'] . '|' . $array[$b]['year'] . '|' . $array[$b]['customer_type']; ?>"><?= $array[$b]['total'] ?></a>
                                        </div>
                                    </td>
                                <?php  } ?>
                                <td class="d-none"></td>
    ...
    <script>
        ...
        function ViewDetails(ids) {
            ...
            var customer_type = $("#customer_type_4").val();
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            //------------------------------------------------
                            // $.ajax({
                            //         url: "<?php echo base_url('admin/ReportAdmin/Reports/DaterangeLeadOppByMonthlyCountsGraph'); ?>",
                            //         type: "POST",
                            //         data: datanew,
