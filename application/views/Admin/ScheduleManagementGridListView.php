									...
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<div class="input-group date">
													<span class="input-group-addon"><i class="icon-calendar"></i></span>
													<input type="text" class="form-control schedule_date_select" id="schedule_date" name="schedule_date" value="<?= date('d M Y'); ?>" placeholder="Enter Schedule Date" onchange="getassignedissueChange12()" autocomplete="off">
												</div>
											</div>
											<label class="control-label col-sm-2" for="Youtube">Employee Name <span style="color: red;">*</span></label>
											<div class="col-sm-4">
												<select class="select-search" name="employee_id" id="employee_id" onchange="getassignedissueChange12()">
										...
										<div class="reminderSetting" style="display: none;">
											<div class="row">
												...
												<div class="form-group col-sm-12">
													<label class="control-label col-sm-2" for="email">Reminder Before Time </label>
													<div class="col-sm-10">
												...
												<div class="form-group col-sm-12">
													<label class="control-label col-sm-2" for="email">Notify By </label>
													<div class="col-sm-10">
										...
										<div class="recuuringData" style="display: none;clear:both">
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control recurring_eod" id="recurring_eod" name="recurring_eod" placeholder="Enter Recurring EOD" autocomplete="off">
												</div>
											</div>
										</div>
									</div>
