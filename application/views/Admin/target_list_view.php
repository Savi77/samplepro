                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <ul class="icons-list" style="display: flex;">
                            <li <?= $ViewClass; ?>><a onclick="view_employee(id)" id="<?= $row['tr_auto_id'] ?>"><span class="label bg-info" style="line-height: 20px;"><i class="glyphicon glyphicon-eye-open" style="font-size: 12px;" data-toggle="tooltip" title="View Allocated Employee List" data-placement="bottom"></i></span></a></li>
                            <li <?= $EditClass; ?>><a data-toggle="modal" onclick="edit_target(id)" id="<?= $row['tr_auto_id'] ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Type" data-placement="bottom"></i></span></a></li>

                            <li <?= $DeleteClass; ?>><a onclick="delete_target(id)" id="<?= $row['tr_auto_id'] ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Type" data-placement="bottom"></i></span></a></li>
                          </ul>
                        </td>
                      </tr>
                    <?php $count++;
    ...
    <div id="modal_default1" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header bg-info" style="background-color:#009FDF;">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h6 class="modal-title"> <i class="icon-file-text" style="zoom:1.1; "></i>
                    &nbsp; &nbsp;Edit Target</h6>
          </div>
