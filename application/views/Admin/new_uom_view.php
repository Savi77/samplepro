...
<style>
   ...
   .popover-body{
    ...
    #MyUOMTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(1),#MyUOMTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(2),#MyUOMTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(3){
        display: none;
    }
    tr.bg {
    ...
    <div class="col-lg-12 p-0">
        <div class="card">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">	
                <span class="span-py-10 white-text">UOM Type</span>
                <a <?= $AddClassP ?> data-toggle="modal" data-target="#UOMList" class="btn btn-link btn-float has-text"><i class="icon-file-plus text-primary"><span class="left-padding">Add</span></i></a>
            </div>

            <!-- datatable-button-flash-basic -->
            <table class="table table-striped" id="MyUOMTable">
                <thead>
                    <tr>
                        <th>Sr No</th>
                        <th>Title</th>
                        ...
                        <tr <?= $bg_color_class ?>>
                            ...
                            <td <?= $StatusClass; ?>>
                                <div style="width:150px;">
                                    <?php if ($row->status == 1) { ?>
                                        <!-- <button type="button" class="green-btn" data-popup="tooltip" title="Click for Inactive" data-placement="bottom" data-original-title="Click for Inactive" id="<?= $row->uom_id ?>" onclick="deactivate(this.id)"> Active </button> -->
                                        <button type="button" class="green-btn" data-popup="tooltip" title="Click for Inactive" data-placement="bottom" data-original-title="Click for Inactive" id="<?= $row->uom_id ?>" onclick="deactivate(this)" data-id="<?= $row->uom_id ?>"> Active </button>
                                    <?php } else { ?>
                                        <!-- <button type="button" class="red-btn" data-popup="tooltip" title="Click for Activate" data-placement="bottom" data-original-title="Click for Activate" id="<?= $row->uom_id ?>" onclick="activate(this.id)"> Inactive </button> -->
                                        <button type="button" class="red-btn" data-popup="tooltip" title="Click for Activate" data-placement="bottom" data-original-title="Click for Activate" id="<?= $row->uom_id ?>" onclick="activate(this)" data-id="<?= $row->uom_id ?>"> Inactive </button>
                                    <?php } ?>
                                </div>
                            ...
                            <!-- <td class="text-center">
                                <div class="row">
                                    <a class="cursor-pointer" data-toggle="modal" onclick="edit_uom(id)" id="<?= $row->uom_id; ?>" data-popup="tooltip" title="Edit schedule" data-placement="bottom" data-original-title="Edit schedule" <?= $EditClass; ?>><i class="fa fa-edit"></i></a>

                                    <a <?= $DeleteClass; ?> class="cursor-pointer" data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->uom_id; ?>" id="<?= $row->uom_id; ?>" data-popup="tooltip" title="Delete UOM Type" data-placement="bottom" data-original-title="Delete UOM Type"><i class="fa fa-trash"></i></a>
                                </div>
                            </td> -->
                                        ...
                                        <li>  
                                            <div>
                                                ...
                                                <div class="my-popover-content" style="display:none">
                                                    <ul>
                                                        <li>
                                                            <a data-toggle="modal" onclick="edit_uom(id)" id="<?= $row->uom_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-green"></span> Edit UOM Type  
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->uom_id; ?>" id="<?= $row->uom_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-red"></span> Delete UOM Type  
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
...
<div id="UOMList" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
...
<div id="modal_default1" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
                <h6 class="card-title py-sm-4 card-headings">Edit UOM Type</h6>
...
<script>
    function del_uom(id) {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to delete this UOM Type?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
        ...
        notice.get().on('pnotify.confirm', function() {
            ...
            var datastring = 'uom_id=' + id;
            //alert(datastring);
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/UOM/delete_uom'); ?>",
                cache: false,
                data: datastring,
                success: function(data) {
                    //alert(data);
...
<script>
    function edit_uom(id) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('admin/UOM/edit_uomtype'); ?>",
            cache: false,
            data: datastring,
            success: function(data) {
                //alert(data);
...
<script>
    function deactivate(id) {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to Inactive this UOM Type?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
        ...
        notice.get().on('pnotify.confirm', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/UOM/deactivate'); ?>",
                cache: false,
                data: datastring,
                success: function(data) {
                    // alert(data);
...
<script>
    function activate(id) {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to activate this UOM Type?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
        ...
        notice.get().on('pnotify.confirm', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/UOM/activate'); ?>",
                cache: false,
                data: datastring,
                success: function(data) {
                    //alert(data);
...
$(document).ready(function(e) 
{
  $("#deleteuomForm").on('submit', (function(e) 
  {
    //e.preventDefault();
    if (e.isDefaultPrevented()) 
    {
...
<div class="modal fade" id="deleteconfirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with deleting this UOM Type?</div>
                <div class="modal-footer" style="justify-content: center;">
                    <form class="form-horizontal" id="deleteuomForm">
...
<div class="modal fade" id="deactivateconfirmationModal" tabindex="-1" aria-labelledby="deactivateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with inactivating this UOM Type?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<div class="modal fade" id="activateconfirmationModal" tabindex="-1" aria-labelledby="activateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with activating this UOM Type?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<script>
    $(document).ready(function(){
        var rescheduleTable = $('#MyUOMTable').DataTable( {       
        scrollCollapse: true,
        paging:         true, 
        // order: [[0, 'desc']],
        // fixedColumns: true,
