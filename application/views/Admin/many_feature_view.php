                        ...
                        <tbody>
                             ...
                             <?php
                              ...
                              <tr>
                                ...
                                <td>
                                   <ul class="icons-list">
                                      <li><a  href="<?php echo base_url("admin/Many_feature/edit_feature?id=$row->id") ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Feature" data-placement="bottom"></i></span></a></li>
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    {   
                        $.ajax({
                           ...
                           url: "<?php echo base_url('admin/Many_feature/add');?>",
                                  type: "POST",
