	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Activity List</span></h4>
			</div>
			<div class="heading-elements">
				<a data-toggle="modal" data-target="#schedule_model" class="btn bg-blue btn-labeled heading-btn"
					<?= $AddClass; ?>><b><i class="icon-task"></i></b> Add Activity</a>
			</div>
		</div>
	</div>
	<!-- /page header -->
										...
										<div class="col-sm-9">
											<div class="input-group date">
												...
												<input type="text" class="form-control" name="start_date" id="start_date"
													placeholder="Please select start date" autocomplete="off" value="<?= date('d M Y'); ?>">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="col-sm-9">
											<div class="input-group date">
												...
												<input type="text" class="form-control" name="end_date" id="end_date"
													placeholder="Please select end date" autocomplete="off" value="<?= date('d M Y'); ?>">
											</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-2" style="margin-right: 2%;margin-left: -2%; <?= $ViewAllDataClass; ?>">
								<div class="form-group">
									<div class="col-sm-12">
										<div class="input-group date">
											<span class="input-group-addon"><i class="icon-shrink3"></i></span>
											<div class="multi-select-full">
												<select class="multiselect-select-all" multiple="multiple" name="employee_list[]">
													<?php
											...
											<div class="col-md-6">
												<div class="panel" style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
													<div class="panel-body">
														<div class="row">
															<div class="col-sm-12">
																...
																<div class="row">
																	<div class="col-md-6" align="left">
																		<ul class="list list-unstyled">
																			<li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_1; ?><br /> <i
																					style="font-size: 10px;">Created on <?= $created_on ?></i></li>
																		</ul>
																	</div>
																	<div class="col-md-6" align="right">
																		<ul class="list list-unstyled ">
                                                                ...
                                                                <ul class="list list-unstyled">
																	<li><i class=" icon-office"></i>&nbsp;: &nbsp;<?= $type; ?></li>
																</ul>
																<div class="row">
																	<div class="col-md-12" align="left">
																		<ul class="list list-unstyled">
																			<li><i class=" icon-magazine"></i>&nbsp;: &nbsp;<span
																					class="text-semibold"><?= $issue_1; ?></span></li>
																		</ul>
																	</div>
																</div>
															</div>
													...
													<div class="panel-footer">
														<ul>
															<li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span
																	class="text-semibold"><?= $issue_list_array[$i]['scheduledatetime']; ?></span></li>
														</ul>
														...
														<ul class="pull-right">
															...
															<li><a id="<?= $ticket_no_1 ?>" onclick="remark_list_pending(this.id)"><i
																		class="icon-eye"></i></a></li>
															<li <?= $DeleteClass; ?>><a id="<?= $query_1 ?>" onclick="delete_activity(this.id)"><i
																		class="icon-trash" style="color: red;"></i></a></li>
														</ul>
											...
											<div class="col-md-6">
												<div class="panel " style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
														...
														<div class="row">
															<div class="col-sm-12">
																...
																<div class="row">
																	<div class="col-md-6" align="left">
																		<ul class="list list-unstyled">
																			<li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_2; ?><br /> <i
																					style="font-size: 10px;">Created on <?= $created_on_2 ?></i></li>
																		</ul>
																	</div>
																	<div class="col-md-6" align="right">
																		<ul class="list list-unstyled ">
																...
																<div class="row">
																	<div class="col-md-12" align="left">
																		<ul class="list list-unstyled">
																			<li><i class=" icon-magazine"></i>&nbsp;: &nbsp;<span
																					class="text-semibold"><?= $issue_2; ?></span></li>
																		</ul>
																	</div>
																</div>
															</div>
													...
													<div class="panel-footer">
														<ul>
															<li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span
																	class="text-semibold"><?= $issue_list_array[$record_cnt]['scheduledatetime']; ?></span>
															</li>
														</ul>
														<ul class="pull-right">
															<li class="dropdown">
															...
															<li><a id="<?= $ticket_no_2 ?>" onclick="remark_list_pending(this.id)"><i
																		class="icon-eye"></i></a></li>
															<li <?= $DeleteClass; ?>><a id="<?= $query_2 ?>" onclick="delete_activity(this.id)"><i
																		class="icon-trash" style="color: red;"></i></a></li>
														</ul>
													</div>
												</div>
											...
											<div class="col-md-6">
												<div class="panel " style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
															...
															<div class="col-sm-12">
																	...
																	<div class="col-md-6" align="left">
																		<ul class="list list-unstyled">
																			<li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_1_reschedule; ?>
																				<br /> <i style="font-size: 10px;">Created on <?= $created_on_3 ?></i> </li>
																		</ul>
																	</div>
																	<div class="col-md-6" align="right">
																		<ul class="list list-unstyled ">
																...
																<div class="row">
																	<div class="col-md-12" align="left">
																		<ul class="list list-unstyled">
																			<li><i class=" icon-magazine"></i>&nbsp;: &nbsp;<span
																					class="text-semibold"><?= $issue_1_reschedule; ?></span></li>
																		</ul>
																	</div>
																</div>
															</div>
													...
													<div class="panel-footer">
														<ul>
															<li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span
																	class="text-semibold"><?= $reschedule_issue_list[$j]['scheduledatetime']; ?></span>
															</li>
														</ul>
														<ul class="pull-right">
															<li><?= $reschedule_issue_list[$j]['status']; ?></li>

															<li><a id="<?= $ticket_no_1_reschedule ?>" onclick="remark_list(this.id)"><i
																		class="icon-eye"></i></a></li>
                        ...
                        ?>
											<div class="col-md-6">
												<div class="panel border-left-lg border-left-success"
													style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
													<div class="panel-body">
														<div class="row">
															<div class="col-sm-12">
																	...
																	<div class="col-md-6" align="left">
																		<ul class="list list-unstyled">
																			<li><i class="icon-calendar"></i>&nbsp;:
																				&nbsp;<?= $created_date_2_reschedule; ?><br /> <i
																					style="font-size: 10px;">Created on <?= $created_on_4 ?></i></li>
																		</ul>
																	</div>
																	<div class="col-md-6" align="right">
																		<ul class="list list-unstyled ">
																...
																<div class="row">
																	<div class="col-md-12" align="left">
																		<ul class="list list-unstyled">
																			<li><i class=" icon-magazine"></i>&nbsp;: &nbsp;<span
																					class="text-semibold"><?= $issue_2_reschedule; ?></span></li>
																		</ul>
																	</div>
																</div>
															</div>
													...
													<div class="panel-footer">
														<ul>
															<li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span
																	class="text-semibold"><?= $reschedule_issue_list[$record_cnt_reschedule]['scheduledatetime']; ?></span>
															</li>
														</ul>
														<ul class="pull-right">
															<li><?= $reschedule_issue_list[$record_cnt_reschedule]['status']; ?></li>
															<li><a id="<?= $ticket_no_2_reschedule ?>" onclick="remark_list(this.id)"><i
																		class="icon-eye"></i></a></li>
											...
											<div class="col-md-6">
												<div class="panel" style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
															...
															<div class="col-sm-12">
																...
																<div class="row">
																	<div class="col-md-12" align="left">
																		<ul class="list list-unstyled">
																			<li><i class=" icon-magazine"></i>&nbsp;: &nbsp;<span
																					class="text-semibold"><?= $issue_1_complete; ?></span></li>
																		</ul>
																	</div>
																</div>
															</div>
													...
													<div class="panel-footer">
														<ul>
															<li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span
																	class="text-semibold"><?= $complete_issue_list[$k]['scheduledatetime']; ?></span></li>
														</ul>
														<ul class="pull-right">
															<li><?= $complete_issue_list[$k]['status']; ?></li>

															<li><a id="<?= $ticket_no_1_complete ?>" onclick="remark_list(this.id)"><i
																		class="icon-eye"></i></a></li>
											...
											<div class="col-md-6">
												<div class="panel " style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
															...
															<div class="col-sm-12">
																...
																<div class="row">
																	<div class="col-md-12" align="left">
																		<ul class="list list-unstyled">
																			<li><i class=" icon-magazine"></i>&nbsp;: &nbsp;<span
																					class="text-semibold"><?= $issue_2_complete; ?></span></li>
																		</ul>
																	</div>
																</div>
															</div>
													...
													<div class="panel-footer">
														<ul>
															<li><i class="icon-alarm-check"></i>&nbsp;: &nbsp;<span
																	class="text-semibold"><?= $complete_issue_list[$record_cnt_complete]['scheduledatetime']; ?></span>
															</li>
														</ul>
														<ul class="pull-right">
															<li><?= $complete_issue_list[$record_cnt_complete]['status']; ?></li>
															<li><a id="<?= $ticket_no_2_complete ?>" onclick="remark_list(this.id)"><i
																		class="icon-eye"></i></a></li>
                            ...
                            if ($all_emp_id == $emp_id) { ?>
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" id="schedule_date" name="schedule_date"
													value="<?= date('d M Y'); ?>" placeholder="Enter Schedule Date" onchange="getassignedissue()">
											</div>
										</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea type="text" class="form-control" id="description" name="description"
									placeholder="Please Enter Description" maxlength="150"></textarea>
							</div>
						</div>
				...
				<div class="modal-body" style="overflow-y: auto; max-height: 550px;">
					<div id="reschedule_data">
						<div class="panel panel-flat">
							<div class="panel-body">
								<div class="col-md-12">
									<form class="form-horizontal" id="reschedule_form" method="POST"
										action="<?= base_url(); ?>admin/ScheduleManagement/ResheduleActivitySubmit">
                      ...
                      ?>
											...
											<div class="form-group">
												<label class="control-label col-sm-2" for="Youtube">Employee Name <span
														style="color: red;">*</span></label>
												<div class="col-sm-4">
													<select class="select-search" name="employee_id" id="employee_id_edit"
														onchange="getassignedissue()" disabled>
														<option value="">Select Employee</option>
														<?php
                            foreach ($employee_list as $value2) {
                              ...
                              if ($ResheduleActivityData->assign_to == $value2->id) { ?>
												...
												<label class="control-label col-sm-2" for="email">Schedule Date <span
														style="color: red;">*</span></label>
												<div class="col-sm-4">
													<input type="text" class="form-control" id="schedule_date_edit" name="schedule_date"
														placeholder="Enter Schedule Date" onchange="getassignedissueResch()" autocomplete="off">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4 clockpicker" data-placement="left" data-align="top" data-autoclose="true">
													<input type="text" class="form-control" id="schedule_end_time" name="schedule_end_time"
														value="" placeholder="Please select end time" onchange="mainInfo1()"
														onclick="document.getElementById('err4').innerHTML='' ">
													<span id="err4" style="color:red; font-size: 12px;"></span>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<select class="form-control" name="schedule_type_id" id="schedule_type_edit" disabled>
														...
														<?php
                            foreach ($schedule_visit_list as $st_value) { ?>
														<option value="<?= $st_value->id ?>"
															<?= $st = ($ResheduleActivityData->schedule_type_id == $st_value->id) ? 'selected' : ''; ?>>
