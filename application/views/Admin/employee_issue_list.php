    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/Dashboard');?>"> <span class="text-semibold">Home</span></a> - Issue
        </h4>
      </div>
                        ...
                        <div class="panel-body" style="padding:0px;">
                          <div class="tabbable">
                            <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                              <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab"><i class=" icon-newspaper2 position-left"></i>Issue List</a></li>
                            </ul>
                            <div class="tab-content">
                              <div class="tab-pane active" id="right-icon-tab1">
                                <table cellspacing="0" class="table datatable-responsive">
                                  <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Ticket No</th>
                                  ...
                                  { 
                                    if ($row['check_assign']=='No') 
                                      ...
                                      else
                                      {
                                            ...
                                            $emp_assign_date = date("d M Y", strtotime($row['assign_date'])) .' '. $startTime ." to ". $endTime;
                                      }
                                    ...
                                    <tr style="background-color: <?= $color ?>">
                                      ...
                                      <td style="padding-right: 2px;"><?= $row['issue'] ?></td>                                      
                                      <td ><?= $emp_assign_date ?></td>
                                      <td align="center">
                                              <ul class="icons-list" style="margin-left: 10px; margin: 0px;">
                                                <li class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu dropdown-menu-right" >
                                                    <li><a onclick="priority_normal(this.id)" id="<?= $row['query_id'] ?>">Normal</a></li>
                                                    <li><a onclick="priority_low(this.id)" id="<?= $row['query_id'] ?>">Low</a></li>
                                                    <li><a onclick="priority_high(this.id)" id="<?= $row['query_id'] ?>">High</a></li>
                                                  </ul>
                                                </li>
                                              </ul>
                                              <span class="label bg-<?= $priority_color ?>" style="line-height: 20px;"><?= $row['priority'] ?></span> 
                                      </td>
                                     <td ><?= date("d M Y", strtotime($row['created_date'])); ?></td>

                                      <td >
                                        <ul class="icons-list">
                                          <li><a onclick="upload_documents(id)"  id="<?= $row['query_id'] ?>"  title="Upload Documents">
                                      ...
                                      <td >
                                        <ul class="icons-list">
                                              <li><a onclick="remark_list(id)" id="<?= $row['ticket_no'] ?>"><span class="label bg-success" style="line-height: 20px;">Remark</span> </a></li>
                                              <!-- <li><a onclick="bill_list(id)"><span class="label bg-info" style="line-height: 20px;">Bill</span> </a></li> -->
                                        </ul>
                                      </td>
                            ...
                            <div class="modal-body" style="overflow-y: auto; max-height: 550px;">
                               <form class="form-horizontal" id="schedule_form">
                                      <div class="row">
                                        ...
                                        <?php
                                         ...
                                         <div class="form-group">
                                             <label class="control-label col-sm-2" for="Youtube">Employee Name <span style="color: red;">*</span></label>
                                              <div class="col-sm-4" >
                                                  <input type="text" class="form-control" value="<?= $name_emp ?>" readonly>
                                                  <input type="hidden" class="form-control" name="employee_id" id="employee_id" value="<?= $emp_id ?>">
                                              </div>
                                              <label class="control-label col-sm-2" for="email">Schedule Date <span style="color: red;">*</span></label>
                                              <div class="col-sm-4">
                                                <input type="text" class="form-control" id="schedule_date" name="schedule_date" placeholder="Select Schedule Date"  onchange="getassignedissue()">
                                              </div>
                                          </div>
                                        ...
                                        <!-- Date :  <input id="txtdate" class="testing" type="text"> -->
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                            <textarea class="form-control" rows="2" id="query" name="query" placeholder="Enter query" maxlength="500" style="height: 50px !important;"></textarea>
                                          </div>
                                        </div>
                                    </div>
<!--                                     <div class="form-group"> 
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-sm-offset-3 col-sm-8">
                                          <button type="submit" class="btn btn-primary pull-right" id="desktopbutton" style="line-height: 1;">
