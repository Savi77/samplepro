  ...
  <div class="page-header">
    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">How We Work</span></h4>
      </div>
              ...
              <div class="panel-body" style="padding:0px;">
                <div class="tabbable">
                  <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                    <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">How We Work List<i class="icon-menu7 position-right"></i></a></li>
                        ...
                        <tbody>
                             ...
                             <?php
                              ...
                              <tr>
                                ...
                                <td><img  class="img-thum" style="height:32px;width:32px;" src="<?= base_url() ?>assets/admin/assets/images/howwework/<?= $row->image ?>"></td>             
                                <td><?= $row->title ?></td>
       ...
       <div id="modal_default" class="modal fade">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header bg-info" style="background-color:#009FDF;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h6 class="modal-title">Edit How We Work</h6>
              </div>
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    {   
                        $.ajax({
                           ...
                           url: "<?php echo base_url('admin/How_we_work/add');?>",
                                  type: "POST",
                                  ...
                                  success: function(data)
                                   {
                                    ...
                                    // $("#inner_page_desc").val('');
                                     ...
                                     new PNotify({
                                             ...
                                             setTimeout(function()
                                               {
                                                   window.location="<?php echo base_url('admin/How_we_work');?>";
                                               }, 1000);
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/How_we_work/deactivate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/How_we_work/activate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('admin/How_we_work/Update_header');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/How_we_work/delete_work'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
...
<script>
    function edit_work(id)
    {
        ...
        //alert(datastring);
         $.ajax({
          type: "post",
          url: "<?php echo base_url('admin/How_we_work/edit_work'); ?>",
          cache: false,    
          data: datastring,
          success: function(data)
          {    
