...
<head>
	...
	<link href="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/css/icons/icomoon/styles.css" rel="stylesheet" type="text/css">
	<link href="http://demo.interface.club/limitless/demo/bs3/Template/layout_5/LTR/default/full/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css">
	<link href="http://demo.interface.club/limitless/demo/bs3/Template/layout_5/LTR/default/full/assets/css/core.min.css" rel="stylesheet" type="text/css">
	<link href="http://demo.interface.club/limitless/demo/bs3/Template/layout_5/LTR/default/full/assets/css/components.min.css" rel="stylesheet" type="text/css">
	<link href="http://demo.interface.club/limitless/demo/bs3/Template/layout_5/LTR/default/full/assets/css/colors.min.css" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->


	<!-- Core JS files -->
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/plugins/loaders/pace.min.js"></script>
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/core/libraries/jquery.min.js"></script>
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/core/libraries/bootstrap.min.js"></script>
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/plugins/loaders/blockui.min.js"></script>
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/plugins/ui/nicescroll.min.js"></script>
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/plugins/ui/drilldown.js"></script>
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/plugins/ui/fab.min.js"></script>
	<!-- /core JS files -->
    ...
    <script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/plugins/visualization/d3/d3_tooltip.js"></script>


	<script src="http://demo.interface.club/limitless/demo/bs3/Template/global_assets/js/demo_pages/general_widgets_stats.js"></script>
	...
	<div class="page-header page-header-inverse">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<div class="dropdown-menu dropdown-content width-350">
								...
								<ul class="media-list dropdown-content-body">
									<li class="media">
										<div class="media-left">
											<img src="../../../../global_assets/images/demo/users/face10.jpg" class="img-circle img-sm" alt="">
									...
									<li class="media">
										<div class="media-left">
											<img src="../../../../global_assets/images/demo/users/face3.jpg" class="img-circle img-sm" alt="">
									...
									<li class="media">
										<div class="media-left"><img src="../../../../global_assets/images/demo/users/face24.jpg" class="img-circle img-sm" alt=""></div>
										<div class="media-body">
											<a href="#" class="media-heading">
									...
									<li class="media">
										<div class="media-left"><img src="../../../../global_assets/images/demo/users/face4.jpg" class="img-circle img-sm" alt=""></div>
										<div class="media-body">
											<a href="#" class="media-heading">
									...
									<li class="media">
										<div class="media-left"><img src="../../../../global_assets/images/demo/users/face25.jpg" class="img-circle img-sm" alt=""></div>
										<div class="media-body">
											<a href="#" class="media-heading">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-toggle="dropdown">
								<img src="../../../../global_assets/images/demo/users/face11.jpg" alt="">
								<span>Victoria</span>
								<i class="caret"></i>
							</a>
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4>General Pages - Stats Widgets</h4>
			</div>
					...
					<li>
						<div data-fab-label="Chat with Jack">
							<a href="#" class="btn bg-pink-400 btn-rounded btn-icon btn-float">
								<img src="../../../../global_assets/images/demo/users/face23.jpg" class="img-responsive" alt="">
							</a>
