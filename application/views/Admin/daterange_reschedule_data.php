  ...
  <div class="panel panel-flat">
    <table class="table datatable-basic" id="ajax_table_reschedule" >          
      <tbody>
        <?php
          ...
          <td style="width:100%;">
            <div class="row">   
              <?php                           
                    ...
                    $created_on321=$complete_issue_list[$k]['created_date'];
               ...
               ?>
                                    ...
                                    <div class="row">
                                      <div class="col-md-6" align="left">                                  
                                        <ul class="list list-unstyled">
                                          <li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_1_complete; ?><br/> <i style="font-size: 10px;">Created on <?= $created_on321 ?></i></li>
                                        </ul> 
                                      </div>
                                      <div class="col-md-6" align="right">
                                         <ul class="list list-unstyled ">
                        ...
                        <?php 
                          ...
                          if($record_cnt_complete<$complete_cnt)
                          {
                            ...
                            $created_on322=$complete_issue_list[$record_cnt_complete]['created_date'];
                                ...
                                <div class="row">
                                  <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                      <div class="col-md-6" align="left">                                  
                                        <ul class="list list-unstyled">
                                          <li><i class="icon-calendar"></i>&nbsp;: &nbsp;<?= $created_date_2_complete; ?><br/> <i style="font-size: 10px;">Created on <?= $created_on322 ?></i></li>
                                        </ul> 
                                      </div>
                                      <div class="col-md-6" align="right">
                                         <ul class="list list-unstyled ">
