...
<body style="overflow-x: hidden;">
    ...
    <?php  $this->load->view('Admin/includes/admin_header'); ?>
        ...
        <div class="page-header">
         ...
         <a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span class="text-semibold">Home</span></a> - Activity List
        </h4>
                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-flat">
                                        <div class="panel-heading table_header">
                                            <h5 class="panel-title" style="color:white">Activity</h5>
                                        </div>
                                                ...
                                                <?php
                                                  ...
                                                  foreach($get_data->result() as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td <?= $StatusClass; ?> >
                                                            <?php if($row->status==1){ ?>
                                                                <a data-popup="tooltip" title="" data-placement="bottom" data-original-title="Click for Inactive" id="<?= $row->activity_id?>" onclick="deactivate(this.id)"><span class="label label-success">Active</span></a>
                                                                <?php } else if($row->status==0) {?>

                                                                    <a data-popup="tooltip" title="" data-placement="bottom" data-original-title="Click for Activate" id="<?= $row->activity_id?>" onclick="activate(this.id)"><span class="label label-danger">Inactive</span></a>
                                                                    <?php } ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <ul class="icons-list" style="display: flex;">
                                                                <li <?= $EditClass; ?> ><a data-toggle="modal" onclick="edit_activity(id)" id="<?= $row->activity_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Activity" data-placement="bottom"></i></span></a></li>
                                                                <li <?= $DeleteClass; ?> ><a onclick="del_activity(id)" id="<?= $row->activity_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Activity" data-placement="bottom"></i></span></a></li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <?php $count++; } ?>
                                ...
                                <div class="panel panel-flat">
                                  <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="activity_title" name="activity_title" placeholder="Enter Activity Title" maxlength="50" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-10">
                                            <button type="submit" class="btn btn-primary pull-right">Submit&nbsp;<span id="preview"></span></button>
                                        </div>
                                    </div>
                                </div>
                              </div>
            ...
            <div id="modal_default" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-info" style="background-color:#009FDF;">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h6 class="modal-title">Edit Activity</h6>
                        </div>
                        <div class="modal-body">
            ...
            $("#TargetTypeForm").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                ...
                else
                 {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('admin/Leads/add_activity');?>",
                        type: "POST",
