                ...
                <table class="table datatable-responsive-control-right">
                  ...
                  <tbody>
                    ...
                    foreach ($array_customer->result() as $row) {
                      ...
                      if ($row->type_id == '0' && $row->business_id == '0' && $row->location_id == '0' && $row->group_id == '0') {
                        $status = "Filled";
                      } else {
                        $status = "Filled";
                      }
                          ...
                          <ul class="icons-list">
                            <li class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right">
                                <li style="<?= $EditClass;?>"><a onclick="edit_customer(id)" id="<?= $row->customer_id ?>"><i class=" icon-pencil5"></i> Edit Customer</a></li>
                                <li style="<?= $DeleteClass;?>"><a onclick="del_customer(id)" id="<?= $row->customer_id ?>"><i class=" icon-trash"></i> Delete Customer</a></li>
                              </ul>
                            </li>
                          </ul>
                        </td>
              ...
              <fieldset class="scheduler-border">
                ...
                <fieldset>
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="email"> Google Address <a onclick="open_google_map2()"><img src="<?= base_url();?>assets/img/map.png" alt="map" style="margin-top: -6%;" data-toggle="tooltip" data-placement="top" title="Click here to get Google location"></a></label>
