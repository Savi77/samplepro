						...
						<div class="col-md-12">
									...
									<div class="page-title">
										<h4>
											...
											<a href="<?php echo base_url('admin/Dashboard/UserManagement');?>"> <span
													class="text-semibold">User Management</span></a>
											- Assign Shift
										</h4>
									</div>
									<div class="heading-elements">
										<div class="heading-btn-group">
											<a data-toggle="modal" data-target="#interest_model" class="btn btn-link btn-float has-text"><i
                          ...
                          <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab"><i class="icon-briefcase3 position-right" style="zoom:1.4;"></i> Assign Employee Shift</a></li>
										...
										<div class="panel-heading table_header">
											<h5 class="panel-title" style="color:white">Assign Employee Shift</h5>
										...
										<div class="tab-content">
                                          ...
                                          ?>
														<tr>
															...
															<td>
																<ul class="icons-list">
																	<li><a data-toggle="modal" onclick="edit_shift(id)"
																			id="<?= $row['shift_id']; ?>"><span class="label bg-success"
																				style="line-height: 20px;"><i class="glyphicon glyphicon-edit"
																					style="font-size: 12px;" data-toggle="tooltip" title="Edit Shift"
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<select class="select-search form-control" name="shift_timing">
													...
													<option value="<?= $res->id ?>">
														<?= $res->shift_title.' -  '.$res->from_timing.' : '.$res->to_timing ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
