...
<div class="sidebar-section">
    <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        <li class="nav-item"> 
            <a href="<?= base_url() ?>admin/Dashboard/view_dashboard" <?php if ($menu == 'dashboard') { ?> class="nav-link active" <?php   }else{ ?> class="nav-link" <?php } ?> > <i class="icon-home4"></i> <span> Dashboard </span> </a> 
        </li>

        <li class="nav-item"> 
            <a href="<?= base_url() ?>admin/Dashboard/emp_profile_setting" <?php if ($menu == 'Company Setting') { ?> class="nav-link active" <?php  }else{   ?> class="nav-link" <?php  } ?> > <img class="dashboars-image-icon" src="<?= base_url() ?>new-assets/assets/Images/company-settings.svg"> Company Setting</a> 
        </li>

        <li class="nav-item accent-3 d-none"> 
        ...
        <li class="nav-item"> <a href="#" class="nav-link"> <img class="dashboars-image-icon" src="<?= base_url() ?>new-assets/assets/Images/product-management.svg"> <span>Product Management</span></a> </li>
        ...
        <li class="nav-item"> 
            <a href="<?= base_url() ?>admin/Utility" <?php if ($menu == 'Utility') { ?> class="nav-link active" <?php  }else{   ?> class="nav-link" <?php  } ?> > <img class="dashboars-image-icon" src="<?= base_url() ?>new-assets/assets/Images/maintenance.png"> <span>Utility</span></a> 
        </li>
        <li class="nav-item d-none"> 
            <a href="<?= base_url() ?>admin/Reminder" <?php if ($menu == 'Reminder') { ?> class="nav-link active" <?php  }else{   ?> class="nav-link" <?php  } ?> > <i class="icon-bell3" ></i> <span>Reminder</span></a> 
        </li>
        <?php
            if ($menu == 'BulkEmail') {
        ...
        <li class="nav-item"> <a href="#" class="nav-link"> <img class="copyright" src="<?= base_url() ?>new-assets/assets/Images/copyright.png"> <span cl;ass="back-text">2022 Buro Force</span></a> </li>
