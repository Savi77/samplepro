...
<div class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-collapse collapse" id="navbar-mobile">
		<ul class="nav navbar-nav">
			<li><a class="sidebar-control sidebar-main-toggle hidden-xs" style="color: black;"><i class="icon-paragraph-justify3"></i></a>
			</li>
		</ul>
		...
		<div class="col-sm-6" id="test">
			<?php $this->load->view('Admin/includes/admin_header_shortcut'); ?>
			
			<div class="col-sm-10">
				<p class="navbar-text1 text-right" style="color: white;font-size: 15px;font-weight: 450;">
					<?php
						$this->db->select('org_timezone');
						$this->db->where('org_id',$_SESSION['org_id']);
						$organsation_array = $this->db->get('tbl_organisation')->row();
						if (!empty($organsation_array)) {
							date_default_timezone_set($organsation_array->org_timezone);
						}else{
				...
				<p class="navbar-text1 text-right" style="color: white;font-size: 11px;font-weight: 450; padding: 0px 30px 0px 1px;">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					...
					<span class="visible-xs-inline-block position-right" style="color: white;">Messages</span>
			...
			<li class="dropdown dropdown-user">
				<a class="dropdown-toggle" data-toggle="dropdown">
					...
					<span style="color: white;"><?= $_SESSION['name']; ?></span>
					<i class="caret"></i>
				</a>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="<?= base_url('admin/dashboard/ViewMyProfile') ?>"><i class="icon-user-plus"></i> My
							profile</a></li>
					<li><a href="<?= base_url('admin/Admin_authentication/logout') ?>"><i class="icon-switch2"></i>
							Logout</a></li>
				</ul>
			</li>
		</ul>
	...
	<div class="breadcrumb-line breadcrumb-line-wide">
		...
		<ul class="breadcrumb-elements">
			...
			<!-- <li><a href="<?= base_url('admin/ScheduleManagement/GridList'); ?>?addschedule"><i class="icon-calendar2 position-left"></i>Add Schedule</a></li>
			   ...
			   <?php } ?> -->
			<li><a data-toggle="modal" data-target="#AddNotesModal"><i class="icon-design position-left"></i>Notes</a>
			</li>
