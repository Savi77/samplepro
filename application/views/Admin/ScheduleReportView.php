                    ...
                    <div class="col-md-12">
                      <div class="panel panel-flat">
                        <div class="panel-body" style="padding:0px;">
                          <div class="tabbable">
                             <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#0096EF;color: white;">
                              <li class="" style="font-size: 18px;color: #ffffff !important;"><a href="#right-icon-tab1" data-toggle="tab"><?= $sidebar['menu'];?> Issue List</a></li>
                             </ul>
                                ...
                                <table id="<?= $id ?>" cellspacing="<?= $cellspacing ?>" class="<?= $class ?>">
                                  <thead>
                                    <tr>
                                        ...
                                        <th class="<?= $hidden ?>">Schedule to</th>
                                        <th>Priority</th>
                                    ...
                                    { 
                                      ...
                                      <tr style="background-color: <?= $color ?>">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <?php } ?>
                                            <!-- <a data-popup="tooltip" title="" data-placement="bottom" onclick="assign_to(this.id)" id=""  data-original-title="Click for assign task"><span class="label label-success">assign</span></a> -->
                                          <?php } ?>
                                        </td>
                                        <td align="center">
