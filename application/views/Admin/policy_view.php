                        ...
                        <tbody>
                             ...
                             <?php
                              ...
                              <tr>
                                ...
                                <td>
                                   <ul class="icons-list">
                                      <li><a  href="<?php echo base_url("admin/Policy/edit?id=$row->id") ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Policy" data-placement="bottom"></i></span></a></li>
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    {   
                        $.ajax({
                           ...
                           url: "<?php echo base_url('admin/Policy/add');?>",
                                  type: "POST",
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/Policy/deactivate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/Policy/activate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('admin/Policy/Update_header');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/Policy/delete'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
...
<script>
    function edit_interest(id)
    {
      ...
      //alert(datastring);
       $.ajax({
        type: "post",
        url: "<?php echo base_url('admin/Policy/edit'); ?>",
        cache: false,    
        data: datastring,
        success: function(data)
        {    
