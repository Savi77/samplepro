...
<head>
	...
	<!-- Theme JS files -->
	<script src="http://demo.interface.club/limitless/demo/Template/global_assets/js/plugins/media/fancybox.min.js"></script>
	...
	<script src="http://demo.interface.club/limitless/demo/Template/global_assets/js/demo_pages/ecommerce_product_list.js"></script>
	<!-- /theme JS files -->
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="index.html" class="d-inline-block">
				<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/logo_light.png" alt="">
			</a>
		</div>
			...
			<ul class="navbar-nav">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								<li class="media">
									<div class="mr-3">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face18.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
								...
								<li class="media">
									<div class="mr-3">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face24.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
								...
								<li class="media">
									<div class="mr-3">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face17.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
								...
								<li class="media">
									<div class="mr-3">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face19.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
								...
								<li class="media">
									<div class="mr-3">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face16.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
							...
							<ul class="media-list">
								<li class="media">
									<div class="mr-3 position-relative">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face10.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
								...
								<li class="media">
									<div class="mr-3 position-relative">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face3.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
								...
								<li class="media">
									<div class="mr-3">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face4.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
										<div class="media-title">
											<a href="#">
								...
								<li class="media">
									<div class="mr-3">
										<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face25.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
										<div class="media-title">
											<a href="#">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
						<img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face11.jpg" class="rounded-circle mr-2" height="34" alt="">
						<span>Victoria</span>
					</a>
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="#"><img src="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/users/face11.jpg" width="38" height="38" class="rounded-circle" alt=""></a>
							</div>
						...
						<div class="card card-body">
							<div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
								<div class="mr-lg-3 mb-3 mb-lg-0">
									<a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/assets/images/demo/products/1.jpeg" data-popup="lightbox">
										<img src="http://demo.interface.club/limitless/demo/Template/global_assets/images/demo/products/1.jpeg" width="96" alt="">
									</a>
								</div>
