...
<style>
   ...
   .popover-body{
    ...
    /* #view_remark table th:first-child,#view_document table th:first-child{
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">
                    <span class="span-py-10 white-text">View Task Details for Task ID <?= $get_details['ticket_no'];?></span>                           
                </div>
                <div>
                    ...
                    <div style="padding:20px;" class="row">
                        ...
                        <!-- <div class="reminderSetting col-sm-12">
                            <div class="row" style="padding:0 0 0 20px;">
                                <div class="form-group col-sm-12 d-flex">
                                    ...
                                    <div class="col-sm-4" style="padding-right:0.4rem;padding-left:0.4rem;">
                                        <input type="text" class="form-control" value ="<?= $get_details['users_ids'];?>" readonly>
                                    </div>
                                    <label class="control-label col-sm-2" style="margin: 10px auto auto;" for="email">Reminder Before Time</label>
                                    <div class="col-sm-4" style="padding-left:0.2rem;">
                                        <input type="text" class="form-control" value ="<?= $get_details['reminder_before_time'];?>" readonly>
                                    </div>
                                </div> -->
                        ...
                        <div class="recuuringData col-sm-12" style="clear:both;padding:0 0 0 30px;">
                            <div class="form-group col-sm-12 d-flex">
                                <label class="control-label col-sm-2" for="email" style="padding-left:0;margin: 10px auto auto 10px;">Recurring Interval </label>
                                <div class="col-sm-4" style="padding-left:0rem;">
                                    <input type="text" class="form-control" value ="<?= $get_details['interval'];?>" readonly>
                                </div>
                                <label class="control-label col-sm-2" for="email" style="padding-left:0;margin: 10px auto auto">Recurring EOD</label>
                                    <div class="col-sm-4" style="padding-left:0rem;">
                                        <div class="input-group">
                                            <span class="input-group-prepend">
                                                <span class="input-group-text"><i class="icon-calendar5"></i></span>
        ...
        <div class="modal-body" style="font-size: 18px;text-align: center;">Document Uploaded Successfully !</div>
            <div class="modal-footer" style="justify-content: center;">
                <a href="<?php echo base_url('admin/ScheduleManagement/Task_view_page?task_id='.$get_details["query"].'')?>">
                    <button type="submit" class="btn" data-dismiss="modal" style="background-color: #1e6196;color: #fff;font-size: 16px;">Ok</button>
                </a>
            </div>
        </div>
    </div>
