    ...
    <div class="page-header-content">
      ...
      <div class="page-title">
        <h4>
          ...
          <a href="<?php echo base_url('admin/Dashboard/view_dashboard'); ?>"> <span class="text-semibold">Dashboard</span></a> - CRM
        </h4>
      </div>
      <div class="heading-elements">
        <div class="heading-btn-group" style="display: flex;">
          <a data-toggle="modal" data-target="#leadopp_model" class="btn btn-link btn-float has-text" <?= $AddClassP; ?>><i class="icon-file-plus text-primary"></i><span>ADD</span></a>
          <a style="color: green; <?= $ImportClass; ?>" onclick="ImportContact()" class="btn btn-link btn-float has-text"><i class="icon-file-excel text-success"></i><span><b>Import Lead</b></span></a>
          <a style="color: red;<?= $ExportClass; ?>" href="<?= base_url('admin/Leads/ExportLeadOpp'); ?>" class="btn btn-link btn-float has-text"><i class="icon-file-excel text-danger"></i><span><b>Export Lead/Opp</b></span></a>
        </div>
      </div>
    </div>
  </div>
        <div class="panel panel-flat">
          <div class="panel-heading table_header">
            <h5 class="panel-title" style="color:white">Leads / Opportunities</h5>
          </div>
                ...
                <tr>
                  <td>
                    <?php if ($row['welcome_email_status'] == 1) { ?>
                      <a><img src="<?= base_url() ?>assets/images/open_welcome.png" alt="welcome" data-popup="tooltip" title="Welcome Email Sent" data-placement="bottom" data-original-title="" width="25px" height="25px"></a>
                    <?php } else { ?>
                      <a onclick="sent_welcome_email('<?= $row['leadopp_id']; ?>')"><img src="<?= base_url() ?>assets/images/welcome.png" alt="welcome" data-popup="tooltip" title="" data-placement="bottom" data-original-title="Send Welcome Email" width="25px" height="25px"></a>
                      <span id="sentWelComeEmail<?= $row['leadopp_id']; ?>"></span>
                    <?php  } ?>
                  </td>
                  <td>
                    <a href="<?= base_url('admin/Leads/ViewDetails') ?>?leadopp_id=<?= $row['leadopp_id'] ?>">
                      <div style="font-weight: 600;width: 120px;color:#0d79d0;"><?= $row['lead_generate_id'] ?></div>
                    </a>
                  </td>
                  <td>
                    <div style="width: 150px;"><?= $row['emp_name'] ?></div>
                  </td>
                  <td><?= $row['customer_type'] ?></td>
                  <td><?= $row['tag'] ?></td>
                  <td>
                    <div style="width: 250px;"><?= $row['company_name'] ?></div>
                  </td>
                  <td>
                    <div style="width: 250px;"><?= $row['contact_person_name1'] ?></div>
                  </td>
                  <td><?= $row['phone_no'] ?></td>
                  <td><?= $row['email'] ?></td>
                  <td>
                    <div style="width: 200px;"><?= $row['prdsrv_name'] ?></div>
                  </td>
                  <td>
                    <div style="width: 200px;"><?= $row['source_title'] ?></div>
                  </td>
                  <td>
                    <div style="width: 200px;"><?= $row['stage_title'] ?></div>
                  </td>
                  <td>
                    <div style="width: 200px;"><?= $row['remarks'] ?></div>
                  </td>
                </tr>
              <?php $count++;
              } ?>
                    ...
                    <form id="LeadForm" method="post">
                      ...
                      <div class="panel panel-flat">
                        ...
                        <fieldset class="scheduler-border">
                          ...
                          <fieldset class="scheduler-border">
                          <legend class="scheduler-border">Enquiry Details</legend>
                            <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <select name="business[]" id="business_lead" multiple class="form-control" style="width: 100%;">
                          ...
                          <fieldset class="scheduler-border">
                            <legend class="scheduler-border">Management</legend>
                            <div class="row">  
                            <div class="col-md-6">
                                <div class="form-group">
                                  <label> Generated By  </label>
                                  <select name="lead_generated_by" id="lead_generated_by" class="form-control" >
                          ...
                          <fieldset class="scheduler-border">
                            <legend class="scheduler-border">Additional Info</legend>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label>Tag  </label>
                          ...
                          <fieldset class="scheduler-border">
                            ...
                            <div id="cat" class="form-group has-feedback has-feedback-left panel panel-default border " style="margin-left: 0%;margin-right: 0%;color: white; background: #515252a8;text-align: center;">
                              <div class="checkbox">
                                <label class="checkbox-inline" style="font-size: 16px;"><input type="checkbox" id="flagData" name="welcome_email_lead" value="Welcome" checked>Send Welcome Mail</label>
                              </div>
                            </div>
                          </fieldset>
                          <br>
                          <div class="text-right">
                            <button type="submit" class="btn btn-primary btn-lg">Submit <i class="fa fa-save position-right"></i></button>
                      ...
                      <div class="panel panel-flat">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <legend class="scheduler-border">Management</legend>
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label> Generated By : </label>
                                    <select name="opp_generated_by" id="opp_generated_by" class="form-control" >
                                      <option value="">Select Generated By</option>
                                      <?php foreach ($employee_list as $emp) {  ?>
                                        <option value="<?= $emp->id; ?>"><?= $emp->name; ?></option>
                                      <?php } ?>
                          ...
                          <fieldset class="scheduler-border">
                            ...
                            <div id="cat" class="form-group has-feedback has-feedback-left panel panel-default border " style="margin-left: 0%;margin-right: 0%;color: white; background: #515252a8;text-align: center;">
                              <div class="checkbox">
                                <label class="checkbox-inline" style="font-size: 16px;"><input type="checkbox" id="flagData" name="welcome_email_opp" value="Welcome" checked>Send Welcome Mail</label>
                              </div>
                            </div>
                          </fieldset>
                          <br>
                          <div class="text-right">
                            <button type="submit" class="btn btn-primary btn-lg">Submit <i class="position-right"></i></button>
                          ...
                          <div class="col-md-9 col-md-offset-3">
                            <div class="input-group">
                              ...
                              <div class="label-block text-right" style="margin-top: 15%;">
                                <span class="label label-danger text-right"><a style="color:white;" href="<?= base_url() ?>assets/ExcelSheet/lead.xlsx"><i class=" icon-download"></i>&nbsp;Download Sample File</a></span>
                              </div>
                            </div>
                          </div>
                        </div>
