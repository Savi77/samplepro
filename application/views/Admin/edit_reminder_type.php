...
<!-- <?php if ($editschedule['user_name'] == 'Na') {   ?>
    <div class="panel-body reminder-panel">
        <div class="form-group reminder-module-type">
            <label class="control-label col-sm-3 m-auto" for="email" style="font-weight: 400;"> Module Type: </label>
            <div class="col-sm-9">
...
<?php      }    ?> -->
<?php
if($editschedule['module_name'] == 'Activity')
{   
    $module_name = 'Task';
}
else
{
    $module_name = $editschedule['module_name'];
}
?>
<div class="card-header header-elements-sm-inline py-sm-0 blue-color-card" style="<?= $editschedule['user_name'] ?>;margin-bottom:20px;">
    <?php 
    if ($editschedule['user_name'] == 'Na') 
    {
    ?>
        <h6 class="card-title py-sm-4 card-headings">Edit Reminder For <?= $editschedule['reminder_title']?> (<?= $module_name ?>)</h6>
    <?php  } else { ?>
        <h6 class="card-title py-sm-4 card-headings">Edit Reminder For <?= $editschedule['reminder_title']?> (<?= $module_name ?>/<?= $editschedule['user_name'] ?>)</h6>
    <?php      }    ?>
...
<form class="form-horizontal" id="EditReminder" style="padding-left: 15px;padding-right: 15px;">
    ...
    <div class="row">
        <div class="form-group col-sm-6">
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control" id="reminder_title" name="reminder_title" placeholder="Enter Title" maxlength="50" value="<?= $editschedule['reminder_title'] ?>">
            </div>
        </div>
        ...
        <div class="form-group col-6">
            ...
            <div class="col-sm-12">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control pickadate-selectors rounded-right" class="form-control schedule_date_select" id="edit_reminder_date" name="reminder_date" value="<?= date('d M, Y', strtotime($editschedule['reminder_date'])); ?>" placeholder="Enter Date" autocomplete="off">
                </div>
            </div>
        </div>
        ...
        <div class="form-group col-6">
            ...
            <div class="col-sm-12 clearfix">
                <div class="input-group edit_clockpicker pull-center" data-placement="bottom" data-align="top" data-autoclose="true">
                    ...
                    <input type="text" class="form-control" id="reminder_time" name="reminder_time" placeholder="Enter Time" autocomplete="off" value="<?= date('H:i', strtotime($editschedule['reminder_time'])); ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-group col-sm-6">
            ...
            <div class="col-sm-12">
                <select class="form-control" name="reminder_before_time" id="reminder_before_time_4" data-placeholder="Select Before Time">
        ...
        <div class="form-group col-6">
            ...
            <div class="col-sm-12">
                <select class="form-control" multiple name="reminder_notify_by[]" id="reminder_notify_by_4" data-placeholder="Select Notify By">
        ...
        <div class="form-group col-sm-6">
            ...
            <div class="col-sm-12">
                <textarea class="form-control" rows="1" id="reminder_note" name="reminder_note" placeholder="Enter Comments" maxlength="500"><?= $editschedule['reminder_note'] ?></textarea>
            </div>
        </div>
        ...
        <div class="form-group col-sm-6">
            ...
            <div class="col-sm-12">
                <select class="form-control" name="edit_recurring_set" id="edit_recurring_set" onchange="showEditDataRecurring(this.value)" data-placeholder="Select Recurring">
        ...
        ?>
        <div id="edit_recuuring_data" style="clear:both; display:none;" class="col-md-12">
            <div class="form-group col-6 col-md-6">
                <label class="control-label col-sm-12" for="email">Recurring Interval </label>
                <div class="col-sm-12">
                    <select class="form-control" name="interval_type" id="interval_type_3" data-placeholder="Select Recurring Interval">
            ...
            <div class="form-group col-6 col-md-6">
                ...
                <div class="col-sm-12">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control pickadate-selectors rounded-right" id="edit_recurring_eod" name="edit_recurring_eod" placeholder="Enter Recurring EOD" autocomplete="off" value="<?= date('d M, Y', strtotime($editschedule['recurring_eod'])); ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function(e) {
        $("#EditReminder").on('submit', (function(e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url: "<?php echo base_url('admin/Reminder/update_reminder'); ?>",
                    type: "POST",
...
<script>
    $('#reminder_before_time_4').select2({
        dropdownParent: $('#modal_default1')
    });
    $('#edit_recurring_set').select2({
        dropdownParent: $('#modal_default1')
    });
    $('#interval_type_3').select2({
        dropdownParent: $('#modal_default1')
    });
    $('#reminder_notify_by_4').select2({
        dropdownParent: $('#modal_default1')
    });
...
<div class="modal fade" id="UpdatesuccessModal" tabindex="-1" aria-labelledby="UpdatesuccessModalLabel" data-keyboard="false" data-backdrop="static" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="width:400px;">
        ...
        <div class="modal-body" style="font-size: 18px;text-align: center;">Reminder Updated Successfully</div>
