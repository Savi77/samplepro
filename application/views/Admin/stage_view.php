                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <ul class="icons-list" style="display: flex;">
                          <li <?= $EditClass; ?>><a data-toggle="modal" onclick="edit_stage(id)" id="<?= $row->stage_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Source" data-placement="bottom"></i></span></a></li>
                          <li <?= $DeleteClass; ?>><a onclick="del_stage(id)" id="<?= $row->stage_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Source" data-placement="bottom"></i></span></a></li>
                        </ul>
                      </td>
                    </tr>
                  <?php $count++;
  ...
  <div id="modal_default1" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-info" style="background-color:#009FDF;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="modal-title"><i class=" icon-grid3"></i>&nbsp; &nbsp;Edit Stage</h6>
        </div>
