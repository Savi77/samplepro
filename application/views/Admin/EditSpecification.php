        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="specification_name" value="<?= $row->specification_name; ?>" placeholder="Enter Specification Name">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group clockpicker" data-autoclose="true">
                    ...
                    <input type="text" class="form-control" name="specification_desc" value="<?= $row->specification_desc; ?>" autocomplete="off" placeholder="Enter Specification Description">
                </div>
            </div>
        </div>
    ...
    $(document).ready(function(e) {
        ...
        $("#editform").on('submit', (function(e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url: "<?php echo base_url('admin/ProductSpecification/Update'); ?>",
                    type: "POST",
...
<div class="modal fade" id="UpdatesuccessModal" tabindex="-1" aria-labelledby="UpdatesuccessModalLabel" data-keyboard="false" data-backdrop="static" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="width:400px;">
        ...
        <div class="modal-body" style="font-size: 18px;text-align: center;">Product Specification Updated Successfully</div>
