    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
          ...
          <a href="<?php echo base_url('admin/Tracking/view_tracking'); ?>"> <span class="text-semibold">Tracking</span></a> - Distance Report
        </h4>
      </div>
    </div>
  </div>
  <!-- /page header -->
                ...
                <div class="tabbable">
                  <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                    <li class="active" style="font-size: 18px;">
                      <a href="#right-icon-tab1" data-toggle="tab"><i class="icon-map position-right"></i>&nbsp;&nbsp;Distance Report</a>
                    </li>
                  </ul>
                  <br>
            ...
            <div class="panel panel-flat">
              <div class="panel-heading table_header">
                <h5 class="panel-title" style="color:white">Distance Report</h5>
              </div>
