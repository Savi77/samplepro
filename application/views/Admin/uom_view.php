    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
          ...
          <a href="<?php echo base_url('admin/ProductSpecification/Product'); ?>"> <span class="text-semibold">Product Management</span></a> - UOM List
        </h4>
      </div>
  ...
  <!-- /page header -->
              ...
              <div class="panel panel-flat">
                <div class="panel-heading table_header">
                  <h5 class="panel-title" style="color:white">UOM</h5>
                  <div class="heading-elements">
                    <td>
                    ...
                    foreach ($get_data->result() as $row) { ?>
                      <tr>
                        ...
                        <td <?= $StatusClass; ?>><?php if ($row->status == 1) { ?>
                            <a data-popup="tooltip" title="" data-placement="bottom" data-original-title="Click for Inactive" id="<?= $row->uom_id ?>" onclick="deactivate(this.id)"><span class="label label-success">Active</span></a>
                          <?php } else { ?>

                            <a data-popup="tooltip" title="" data-placement="bottom" data-original-title="Click for Activate" id="<?= $row->uom_id ?>" onclick="activate(this.id)"><span class="label label-danger">Inactive</span></a>
                          <?php } ?>
                        </td>
                        <td class="text-center">
                          <ul class="icons-list" style="display: flex;">
                            <li <?= $EditClass; ?>><a data-toggle="modal" onclick="edit_uom(id)" id="<?= $row->uom_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit UOM" data-placement="bottom"></i></span></a></li>

                            <li <?= $DeleteClass; ?>><a onclick="del_uom(id)" id="<?= $row->uom_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete UOM" data-placement="bottom"></i></span></a></li>
    ...
    <div id="modal_default1" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header bg-info" style="background-color:#009FDF;">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h6 class="modal-title"><i class="icon-steering-wheel"></i>&nbsp;&nbsp;Edit UOM Type</h6>
          </div>
