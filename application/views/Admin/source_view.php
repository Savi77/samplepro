								...
								<div class="page-title">
									<h4>
										...
										<a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span
												...
												<a href="<?php echo base_url('admin/Master/view_master');?>"> <span
												class="text-semibold">Masters</span></a> - Source List
									</h4>
								</div>
                          ...
                          foreach($get_data->result() as $row) { ?>
									<tr>
										...
										<td <?= $StatusClass;?>><?php if($row->status==1){ ?>
											<a data-popup="tooltip" title="" data-placement="bottom" data-original-title="Click for Inactive"
												id="<?= $row->source_id?>" onclick="deactivate(this.id)"><span
													class="label label-success">Active</span></a>
											<?php } else if($row->status==0) {?>

											<a data-popup="tooltip" title="" data-placement="bottom" data-original-title="Click for Activate"
												id="<?= $row->source_id?>" onclick="activate(this.id)"><span
													class="label label-danger">Inactive</span></a>
											<?php } ?>
										</td>
										<td class="text-center">
											<ul class="icons-list" style="display: flex;">
												<li <?= $EditClass;?>><a data-toggle="modal" onclick="edit_source(id)"
														id="<?= $row->source_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i
																class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip"
																title="Edit Source" data-placement="bottom"></i></span></a></li>
												<li <?= $DeleteClass;?>><a onclick="del_source(id)" id="<?= $row->source_id; ?>"><span
															class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash"
																style="font-size: 12px;" data-toggle="tooltip" title="Delete Source"
				...
				<div class="modal-body">
					<form class="form-horizontal" id="TargetTypeForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="source_title" name="source_title"
									placeholder="Enter Source Title" maxlength="50">
							</div>
						</div>
