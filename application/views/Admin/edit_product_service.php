...
<?php foreach ($edit_prd_srv as $value) 
{
  ?>
         <form class="form-horizontal" id="edit_product_service">
                          ...
                          <div class="form-group">
                            <label class="control-label col-sm-2" for="SGST">SGST <span style="color: red;">*</span></label>
                            <div class="col-sm-2">
                            ...
                            <label class="control-label col-sm-1" for="CGST">CGST <span style="color: red;">*</span></label>
                            <div class="col-sm-3">
                            ...
                            <label class="control-label col-sm-1" for="IGST">IGST <span style="color: red;">*</span></label>
                            <div class="col-sm-3">
