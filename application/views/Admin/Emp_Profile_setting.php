                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control " placeholder="Enter Company Name" name="org_cname" maxlength="150" autocomplete="off" value="<?= $organsation_array->org_cname; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control " placeholder="Enter domain" maxlength="50" id="org_cdomain" name="org_cdomain" autocomplete="off" value="<?= $organsation_array->org_cdomain; ?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="avtara" style="background:#fff;">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-7 col-sm-6 w-90">
                                                                    <input type="text" class="form-control " placeholder="Enter First Name" name="org_fname" id="org_fname" autocomplete="off" value="<?= $organsation_array->org_fname; ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-4 col-form-label left-align">Last Name </label>
                                                                <div class="col-lg-7 col-sm-6 w-90">
                                                                    <input type="text" class="form-control " placeholder="Enter Last Name" name="org_lname" id="org_lname" autocomplete="off" value="<?= $organsation_array->org_lname; ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-4 col-form-label left-align">Email / User Name </label>
                                                                <div class="col-lg-7 col-sm-6 w-90">
                                                                    <input type="text" id="org_email" class="form-control " placeholder="Enter Email" name="org_email" autocomplete="off" value="<?= $organsation_array->org_email; ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-4 col-form-label left-align">Contact No. </label>
                                                                <div class="col-lg-7 col-sm-6 w-90">
                                                                    <input type="text" class="form-control " placeholder="Contact No." name="org_contact" maxlength="10" autocomplete="off" value="<?= $organsation_array->org_contact; ?>" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-7 col-sm-6 w-90">
                                                                    <input type="text" class="form-control " placeholder="Landline" name="org_landline" autocomplete="off" value="<?= $organsation_array->org_landline; ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-4 col-form-label left-align">Address </label>
                                                                <div class="col-lg-7 col-sm-6 w-90">
                                                                    <textarea class="form-control" rows="3" name="org_address" onblur="bind_address(this.value)" readonly><?= $organsation_array->org_address; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row margin-0">
                                                                <label class="col-lg-4 col-form-label left-align">Website </label>
                                                                <div class="col-lg-7 col-sm-6 w-90">
                                                                    <input type="text" class="form-control " placeholder="Website" name="org_website" autocomplete="off" value="<?= $organsation_array->org_web_url; ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body padding-30">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label>Country</label>
                                                                    <select data-placeholder="Please Select Country" class="form-control form-control-select2" name="org_country" id="org_country" onchange="GetState(this.value)" disabled>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label>State </label>
                                                                    <select data-placeholder="Please Select State" class="form-control form-control-select2" data-fouc name="org_state" id="bind_state_list" disabled>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label>City</label>
                                                                    <input type="text" class="form-control " placeholder="City Name" name="org_city" autocomplete="off" value="<?= $organsation_array->org_city ?>" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control " placeholder="Post Code" name="org_postcode" autocomplete="off" maxlength="6" value="<?= $organsation_array->org_postcode ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select data-placeholder="Please Select Time Zone" class="form-control form-control-select2" id="cmp_time_zone" data-fouc name="org_timezone" disabled>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select data-placeholder="Please Select Currency" class="form-control form-control-select2" data-fouc name="org_currency" id="cmp_currency" disabled>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control " rows="1" placeholder="About Comapny" name="org_abt_compnay" maxlength="100" readonly><?= $organsation_array->org_abt_compnay ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                    <label>GST Applicable</label>
                                                                    <select class="form-control form-control-select2" name="gst_applicable" onchange="gst_details(this.value)" id="cmp_gst_applicable" data-placeholder="Select GST Applicable" disabled>
                                                                        <option value="">Select GST Applicable</option>
                                                                        <option value="Yes" <?php if ($gst_applicable == 'Yes') {
                                                                                                echo 'selected';
                                                                                            } ?>>Yes</option>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                    <label>GST</label>
                                                                    <input type="text" placeholder="GST No." class="form-control" name="gst_no" id="gst_no" maxlength="15" value="<?= $gst_no; ?>" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
