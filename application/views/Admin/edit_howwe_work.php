                  ...
                  <div class="col-lg-9">
                    <div class="media no-margin-top">
                      <div class="media-left">
                        <a href="#"><img src="<?= base_url() ?>assets/admin/assets/images/howwework/<?= $value->image ?>" style="width: 58px; height: 58px;" class="img-rounded" alt="" id="blah1"></a>
                      </div>
                 ...
                 {  
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    else
                    {
                              ...
                              $.ajax({
                                 url: "<?php echo base_url('admin/How_we_work/update');?>",
                                type: "POST",
