                            ...
                            <div class="panel"  style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
                              ...
                              <div class="panel-footer">                            
                                ...
                                <ul class="pull-right">
                                  ...
                                  <li><a  id="<?= $query_1_complete ?>" onclick="restore_activity(this.id)"><i class="icon-store2"></i></a></li>
                                  <li <?= $DeleteClass; ?> ><a id="<?= $query_1_complete ?>" onclick="permanent_delete_activity(this.id)"><i class="icon-trash" style="color: red;"></i></a></li>
                                </ul> 
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="panel"  style="box-shadow: 0 1px 3px rgba(0,0,0,.12), 0 1px 2px rgba(0,0,0,.24);">
                              ...
                              <div class="panel-footer">                            
                                ...
                                <ul class="pull-right">
                                  <li><a  id="<?= $query_2_complete ?>" onclick="restore_activity(this.id)"><i class="icon-store2"></i></a></li>
                                  <li <?= $DeleteClass; ?> ><a id="<?= $query_2_complete ?>" onclick="permanent_delete_activity(this.id)"><i class="icon-trash" style="color: red;"></i></a></li>
                                </ul> 
