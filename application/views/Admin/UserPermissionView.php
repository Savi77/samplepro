            ...
            <?php $this->load->view('Admin/includes/panel'); ?>
                  ...
                  <div class="page-header-content">
                    <div class="page-title">
                      <h4>
                        ...
                        <a href="<?php echo base_url('admin/Dashboard/UserManagement'); ?>"> <span class="text-semibold">User Management</span></a> : User Permission

                      </h4>
                    </div>
                    <div class="heading-elements">
                        <div class="heading-btn-group">
                            <a data-toggle="modal" data-target="#interest_model" class="btn btn-link btn-float has-text"><i class="icon-copy4 text-primary"></i><span>Copy Permission</span></a>
                        </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="panel panel-flat">
                <div class="panel-heading table_header">
                  <h5 class="panel-title" style="color:white">User Permission</h5>
                  <div class="heading-elements">
                  </div>
                </div>
                <div class="row">
                        ...
                        <fieldset>
                          ...
                          <div class="col-md-3">
                            <div class="form-group" style="margin-top:11%;">
                              <button type="submit" class="btn btn-primary">Fetch Module
