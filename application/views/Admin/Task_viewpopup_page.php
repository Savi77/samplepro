                                ...
                                <div class="input-group">
                                    ...
                                    <!-- <div class="recuuringData col-sm-12" style="clear:both;padding:0 0 0 30px;">
                                        <div class="form-group col-sm-12 d-flex">
                                            ...
                                            <label class="control-label col-sm-2" for="email" style="padding-right:0;margin: 10px auto auto">Recurring EOD</label>
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        <span class="input-group-prepend">
                                                            <span class="input-group-text"><i class="icon-calendar5"></i></span>
                            ...
                            <table class="table table-striped" style="border:1px solid #dddddd;">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <a  style="color:#333333; font-weight: 600;" target="_blank" href="<?= base_url() ?>assets/admin/scheduledocuments/<?= $document; ?>">
                                                    <?= $file;?>
                                                </a>
                                            </div>
                                        </td> 
                                ...
                                ?>
                                <tr>
                                    <td colspan="3" class="dataTables_empty" style="text-align: center;">No data available in table</td>
                                </tr>
                                <?php
                                }
                                ?>
...
<?php $this->load->view('Admin/includes/n-footer'); ?>data-dismiss="modal"