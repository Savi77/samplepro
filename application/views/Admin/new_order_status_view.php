...
<style>
   ...
   .popover-body{
    ...
    tr.bg {
     ...
     #MyOrderStatusListTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(1),#MyOrderStatusListTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(2),#MyOrderStatusListTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(3){
        display: none;
    }
    .datatable-header {
        padding-top: 1.25rem !important;
    }
    #MyOrderStatusListTable th:first-child{
    ...
    <div class="col-lg-12 p-0">
        <div class="card">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">	
                <span class="span-py-10 white-text">Order Status List</span>
            ...
            <table class="table table-striped" id="MyOrderStatusListTable">
                <thead >
                    <tr>
                        <th>Sr No</th>
                        ...
                        <tr <?= $bg_color_class ?>>
                            ...
                            <td <?= $StatusClass; ?>><?php if ($row->status == 1) { ?>
                                <div style="width:150px;">
                                    <button type="button" class="green-btn" data-popup="tooltip" title="Click for Inactive" data-placement="bottom" data-original-title="Click for Inactive" id="<?= $row->order_status_id ?>" onclick="deactivate(this)" data-id="<?= $row->order_status_id ?>"> Active </button>
                                    <?php } else { ?>
                                        <button type="button" class="red-btn" data-popup="tooltip" title="Click for Activate" data-placement="bottom" data-original-title="Click for Activate" id="<?= $row->order_status_id ?>" onclick="activate(this)" data-id="<?= $row->order_status_id ?>"> Inactive </button>
                                    <?php } ?>
                                </div>
                            </td>
                            ...
                            <!-- <td class="text-center">
                                <div class="row">
                                    <a class="cursor-pointer" data-toggle="modal" onclick="edit_status(id)" id="<?= $row->order_status_id; ?>" data-popup="tooltip" title="Edit Order Status" data-placement="bottom" data-original-title="Edit Order Status" <?= $EditClass; ?>><i class="fa fa-edit"></i></a>
                                    <a <?= $DeleteClass; ?> class="cursor-pointer" data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->order_status_id ?>" id="<?= $row->order_status_id; ?>" data-popup="tooltip" title="Delete Order Status" data-placement="bottom" data-original-title="Delete Order Status"><i class="fa fa-trash"></i></a>
                                        ...
                                        <li>  
                                            <div>
                                                ...
                                                <div class="my-popover-content" style="display:none">
                                                    <ul>
                                                        <li>
                                                            <a data-toggle="modal" onclick="edit_status(id)" id="<?= $row->order_status_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-green"></span> Edit Order Status  
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->order_status_id ?>" id="<?= $row->order_status_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-red"></span> Delete Order Status  
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                ...
                <div class="modal-body">
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <div class="col-sm-12 p-0">
                            <input type="text" class="form-control" id="status_name" name="status_name" placeholder="Enter Order Status Name" maxlength="15">
                        </div>
                    </div>
...
<div id="modal_default1" class="modal fade" data-keyboard="false" data-backdrop="static" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
                <h6 class="card-title py-sm-4 card-headings">Edit Order Status List</h6>
...
<div class="modal fade" id="deleteconfirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with deleting this Order Status?</div>
                <div class="modal-footer" style="justify-content: center;">
                    <form class="form-horizontal" id="deleteorderstatusForm">
...
<div class="modal fade" id="deactivateconfirmationModal" tabindex="-1" aria-labelledby="deactivateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with inactivating this Order Status?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<div class="modal fade" id="activateconfirmationModal" tabindex="-1" aria-labelledby="activateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with activating this Order Status?</div>
                <div class="modal-footer" style="justify-content: center;">
...
$(document).ready(function(e) 
{
  $("#deleteorderstatusForm").on('submit', (function(e) 
  {
    //e.preventDefault();
    if (e.isDefaultPrevented()) 
    {
...
<script>
    $(document).ready(function(){
        var rescheduleTable = $('#MyOrderStatusListTable').DataTable( {       
        scrollCollapse: true,
        paging:         true, 
        // order: [[0, 'desc']],
        // fixedColumns: true,
