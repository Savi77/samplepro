        ...
        <table class="table table-striped" style="border:1px solid #dddddd;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a target="_blank" href="<?= base_url() ?>assets/admin/contactmanagementdocuments/<?= $document; ?>">
                                        ...
                                        <div class="my-popover-content" style="display:none">
                                            <ul>
                                                <li>
                                                    ...
                                                    <a target="_blank" href="<?= base_url() ?>assets/admin/contactmanagementdocuments/<?= $document; ?>" style="color:#333333;">
