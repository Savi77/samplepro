    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/ProductSpecification/Product');?>"> <span class="text-semibold">Product Management</span></a> - Product Specification
        </h4>
      </div>
  ...
  <!-- /page header -->
              <div class="panel panel-flat" >
                <div class="panel-heading table_header">
                  <h5 class="panel-title" style="color:white">Product Specification</h5>
                </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?= $row->specification_desc; ?></td>
                        <td class="hidden"><?= $row->credit_days; ?></td>
                        <td class="hidden"></td>
                        <td>
                          <ul class="icons-list" style="display: flex;">
                            <li <?= $EditClass; ?>><a data-toggle="modal" onclick="Edit(id)" id="<?= $row->specification_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit" data-placement="bottom"></i></span></a></li>
                            <li <?= $DeleteClass; ?>><a data-toggle="modal" onclick="Delete(id)" id="<?= $row->specification_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete" data-placement="bottom"></i></span></a></li>
                          </ul>
                        </td>
                      </tr>
                    <?php $count++;
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group clockpicker" data-autoclose="true">
                        <label>Specification Description : <sup style="color: red">*</sup></label>
                        <input type="text" class="form-control" name="specification_desc" autocomplete="off">
                      </div>
                    </div>
                  </div>
                </fieldset>
