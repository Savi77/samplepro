    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span class="text-semibold">Home</span></a> -  Plan
        </h4>
      </div>
                      ...
                      <div class="tabbable">
                        <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#00619F;">
                          <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">
                            <i class=" icon-grid5 position-right" style="zoom:1.4;"></i> &nbsp; Plan </a></li>
                        </ul>
                                          ...
                                          <?php 
                                            ...
                                            ?>
                                              <tr>
                                                ...
                                                <td>
                                                    <ul class="icons-list">
                                                        <li><a data-toggle="modal" onclick="EditDetails(id)" id="<?= $row['plan_id']; ?>">
                                                        ...
                                                        <li><a data-toggle="modal" onclick="DeleteDetails(id)" id="<?= $row['plan_id']; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete" data-placement="bottom"></i></span></a></li>
                                                    </ul>
                                                </td>
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: #2196f3; color: white;padding: 13px; height: 55px;">
               <button type="button" style="color: white;top: 25%;font-weight:600;" class="close" data-dismiss="modal">&times;</button>
                  ...
                  <i class="icon-store2" style="zoom:1.1; "></i>
                    &nbsp; &nbsp;Add Plan
                  </h5>
              </div>
                              ...
                              <div class="col-md-12"> 
                                <div class="form-group">
                                   <label>Plan Title : <sup style="color: red">*</sup></label>
                                    <input type="text" class="form-control" name="plan_name" autocomplete="off">
                                </div>
                              </div>          
                          </div>
                        </fieldset>  
                              ...
                              <div class="col-md-12"> 
                                <div class="form-group">
                                   <label>Plan Price : <sup style="color: red">*</sup></label>
                                    <input type="text" class="form-control" name="price" autocomplete="off"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 43 || event.charCode == 45'>
                                </div>
                              </div>          
                          </div>
                        </fieldset>  
                            ...
                            <div class="col-md-6"> 
                              <div class="form-group">
                                 <label>Discount Amount : <sup style="color: red">*</sup></label>
                                  <input type="text" class="form-control" name="discount_amount"   autocomplete="off"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 43 || event.charCode == 45' >
                              </div>
                            </div> 
                            <div class="col-md-6"> 
                              <div class="form-group">
                                 <label>Discount Percentage : <sup style="color: red">*</sup></label>
                                  <input type="text" class="form-control" name="discount_perc"   autocomplete="off"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 43 || event.charCode == 45' >
                              </div>
                            </div>  
                        </div>
                      </fieldset> 
                                  ...
                                  <div class="multi-select-full">
                                    <select class="multiselect-select-all" multiple="multiple" name="module_ids[]">
                                        <?php   
                                          ...
                                          {
                                        ?>
                                        <option value="<?= $res->module_id;?>"><?= $res->module_name;?></option>
                                       <?php } ?> 
                                    </select>
                                  </div>
                                </div>
     ...
     <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header bg-info" style="background-color:#00619F;">
            ...
            <h6 class="modal-title"><i class="icon-store2" style="zoom:1.1; "></i>
             &nbsp; &nbsp;Edit Plan</h6>
          </div>
          <div class="modal-body">
           ...
           {  
             ...
             if (e.isDefaultPrevented())
              ...
              else
              {
                  ...
                  $.ajax({
                    url: "<?php echo base_url('admin/PlanMaster/AddDetails'); ?>",
                    type: "POST",
                    ...
                    success: function(data)
                      {
                        ...
                        // alert(data);
                         $(function()
                         {
                           ...
                           setTimeout(function()
                             {
                                 window.location="<?php echo base_url('admin/PlanMaster');?>";
                             }, 1000);
                      },
                      error: function() 
                      {
...
<script>
function EditDetails(plan_id)
{
    $(window).scrollTop(0);
    var datastring = 'plan_id='+plan_id;
    // alert(datastring);
     $.ajax({
      type: "post",
      url: "<?php echo base_url('admin/PlanMaster/EditDetails'); ?>",
      cache: false,    
      data: datastring,
      success: function(data)
      {    
...
<script type="text/javascript">
 function DeleteDetails(module_id)
 {
      var notice = new PNotify({
                    title: 'Confirmation',
                    text: '<p>Are you sure you want to delete this title ?</p>',
                    hide: false,
                    type: 'warning',
                    confirm: {
                        confirm: true,
        ...
        notice.get().on('pnotify.confirm', function()
         {
             var datastring='module_id='+module_id;
              $.ajax({
              url: '<?php echo base_url('admin/PlanMaster/DeleteDetails') ?>',
              type: "POST",
              data:  datastring,
              success: function(data)
                {
