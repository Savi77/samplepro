                        ...
                        <table class="table">
                          <tbody>
                            <tr>
                              ...
                              <td><a href="https://www.buroforce.com" target="_blank">Buroforce</a></td>
                            </tr>
                            <tr>
                          ...
                          <fieldset>
                            ...
                            <form class="form-horizontal" id="statusform">
                              ...
                              <div class="text-right">
                                <button type="submit" id="button-history" data-loading-text="Loading..." class="btn btn-primary" <?= $OrderStatusClass; ?> ><i class="fa fa-plus-circle"></i> Update Status</button>
                              </div>
                            </form>
                          </fieldset>
                        </div>
