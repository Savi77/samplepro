    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
          ...
          <a href="<?php echo base_url('admin/Tracking/view_tracking'); ?>"> <span class="text-semibold">Tracking</span></a> - Tracking Report
        </h4>
      </div>
    </div>
  </div>
  <!-- /page header -->
              ...
              <div class="panel panel-flat">
                <div class="panel-heading table_header">
                  <h5 class="panel-title" style="color:white">Tracking</h5>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12" id="displaydata" style="display:none;">
                    <fielsdset>
                      ...
                      <div class="checkbox-inline">
                        <img src="<?= base_url() ?>assets/img/start.png" style="height:24px;width:24px;" />
                        <label for="inlineCheckbox2"> START </label>
                      </div>

                      <div class="checkbox-inline">
                        <img src="<?= base_url() ?>assets/img/end.png" style="height:24px;width:24px;" />
                        <label for="inlineCheckbox4"> END </label>
                      </div>

                      <div class="checkbox-inline">
                        <img src="<?= base_url() ?>assets/img/gps.png" style="height:24px;width:24px;" />
