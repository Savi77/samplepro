...
<style>
   ...
   .popover-body{
    ...
    tr.bg {
     ...
     #MyContactTypeTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(1),#MyContactTypeTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(2),#MyContactTypeTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(3){
        display: none;
    }
    #MyContactTypeTable th:first-child{
    ...
    <div class="col-lg-12 p-0">
        <div class="card">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">	
                <span class="span-py-10 white-text">Contact Type List</span>
                <a <?= $AddClassP ?> data-toggle="modal" data-target="#Contact-Type" class="btn btn-link btn-float has-text"><i class="icon-file-plus text-primary"><span class="left-padding">Add</span></i></a>
            </div>
            <!-- datatable-button-flash-basic -->
            <table class="table table-striped" id="MyContactTypeTable">
                <thead>
                    <tr>
                        <th>Sr No</th>
                        <th>Contact Type</th>
                ...
                <tbody>
                    <?php
                    $count = 1;
                    foreach ($get_typedata->result() as $row) {
                        if ($count % 2 == 0) {
                        ...
                        <tr <?= $bg_color_class ?>>
                            ...
                            <td <?= $StatusClass; ?>><?php if ($row->status == 1) { ?>
                                <div style="width:150px;">
                                    <button type="button" class="green-btn" data-popup="tooltip" title="Click for Inactive" data-placement="bottom" data-original-title="Click for Inactive" id="<?= $row->type_id ?>" onclick="deactivate(this)" data-id="<?= $row->type_id ?>"> Active </button>
                                    <?php } else { ?>
                                        <button type="button" class="red-btn" data-popup="tooltip" title="Click for Activate" data-placement="bottom" data-original-title="Click for Activate" id="<?= $row->type_id ?>" onclick="activate(this)" data-id="<?= $row->type_id ?>"> Inactive </button>
                                    <?php } ?>
                                </div>
                            </td>
                            ...
                            <!-- <td class="text-center">
                                <div class="row">
                                    <a class="cursor-pointer" data-toggle="modal" onclick="edit_client(id)" id="<?= $row->type_id; ?>" data-popup="tooltip" title="Edit Contact Type" data-placement="bottom" data-original-title="Edit Contact Type" <?= $EditClass; ?>><i class="fa fa-edit"></i></a>
                                    <a <?= $DeleteClass; ?> class="cursor-pointer" data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->type_id ?>" id="<?= $row->type_id; ?>" data-popup="tooltip" title="Delete Contact Type" data-placement="bottom" data-original-title="Delete Contact Type"><i class="fa fa-trash"></i></a>
                                        ...
                                        <li>  
                                            <div>
                                                ...
                                                <div class="my-popover-content" style="display:none">
                                                    <ul>
                                                        <li>
                                                            <a data-toggle="modal" onclick="edit_client(id)" id="<?= $row->type_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-green"></span> Edit Contact Type  
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->type_id ?>" id="<?= $row->type_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-red"></span> Delete Contact Type  
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
...
<div id="Contact-Type" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
            ...
            <form class="form-horizontal" id="TypeForm">
                <div class="modal-body">
                    <div class="form-group mb-0">
                        <label class="control-label col-sm-12 p-0" for="email">Contact Type Title <span style="color: red;">*</span></label>
                ...
                <div class="modal-footer" style="padding-right: 20px;padding-bottom: 25px;">
...
<div id="modal_default1" class="modal fade" data-keyboard="false" data-backdrop="static" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
                <h6 class="card-title py-sm-4 card-headings">Edit Contact Type List</h6>
...
<script>
    function del_client(id) {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to delete this Contact Types?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
        ...
        notice.get().on('pnotify.confirm', function() {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/Master/delete_type'); ?>",
                cache: false,
                data: datastring,
                success: function(data) {
                    //alert(data);
...
<script>
    function edit_client(id) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url('admin/Master/edit_mastertype'); ?>",
            cache: false,
            data: datastring,
            success: function(data) {
                //alert(data);
...
<script>
    function deactivate(id) {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to Inactive this Contact Types?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
...
<script>
    function activate(id) {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to activate this Contact Types?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
...
<div class="modal fade" id="deleteconfirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with deleting this Contact Type?</div>
                <div class="modal-footer" style="justify-content: center;">
                    <form class="form-horizontal" id="deletecontacttypeForm">
...
<div class="modal fade" id="deactivateconfirmationModal" tabindex="-1" aria-labelledby="deactivateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with inactivating this Contact Type?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<div class="modal fade" id="activateconfirmationModal" tabindex="-1" aria-labelledby="activateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with activating this Contact Type?</div>
                <div class="modal-footer" style="justify-content: center;">
...
$(document).ready(function(e) 
{
  $("#deletecontacttypeForm").on('submit', (function(e) 
  {
    //e.preventDefault();
    if (e.isDefaultPrevented()) 
    {
...
<script>
    $(document).ready(function(){
        var rescheduleTable = $('#MyContactTypeTable').DataTable( {       
        scrollCollapse: true,
        paging:         true, 
        // order: [[0, 'desc']],
        // fixedColumns: true,
