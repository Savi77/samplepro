...
<body class="sidebar-xs1">
                ...
                <div class="page-header-content">
                    <div class="page-title">
                        <h4>
                            ...
                            <a href="<?= base_url() ?>admin/Dashboard/view_dashboard"> <span class="text-semibold">Dashboard</span></a> - Transfered List
                        </h4>
                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" class="form-control schedule_date_select" id="schedule_date" name="schedule_date" value="<?= date('d M Y'); ?>" placeholder="Enter Schedule Date" onchange="getassignedissue()">
                                                </div>
                                            </div>
    ...
    <div id="modal_default" class="modal fade" style="top: 10%;z-index: 999;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
    ...
    <!--  -->
    <!-- Modal -->
    <div class="modal fade" id="issue_details" role="dialog" style="z-index: 9999;
    top: 10%;">
        <div class="modal-dialog modal-lg">
