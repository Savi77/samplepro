                 ...
                 {  
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    else
                    {
                              ...
                              $.ajax({
                                 url: "<?php echo base_url('admin/Client/Add_client');?>",
                                type: "POST",
                                ...
                                success: function(data)
                                  {
                                  				// alert(data);
                                                   ...
                                                   setTimeout(function()
                                                     {
                                                         window.location="<?php echo base_url('admin/Client');?>";
                                                     }, 1000);
    ...
    function del_client(id)
    {
      ...
      var datastring = 'clientid='+id;
            //alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/Client/delete_client'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
...
<script>
    function edit_client(id)
    {
      ...
      //alert(datastring);
       $.ajax({
        type: "post",
        url: "<?php echo base_url('admin/Client/edit_client'); ?>",
        cache: false,    
        data: datastring,
        success: function(data)
        {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/Client/deactivate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('admin/Client/activate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
