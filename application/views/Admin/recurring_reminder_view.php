                ...
                <div class="page-header">
                    <div class="page-header-content">
                        ...
                        <div class="heading-elements">
                            <button type="submit" class="btn btn-danger pull-right" onclick="deleteReminder(<?= $reminder_id ?>)">Delete&nbsp;<i class="icon-trash position-right"></i> </button>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= date('d M, Y', strtotime($row->recurring_date)) ?> / <?= date('H:i A', strtotime($row->recurring_time)) ?>
                                    </td>
                                    <td> <?= $row->notify_by ?> </td>
                                    <td class="text-center">
                                        <ul class="icons-list">
                                            <li><a data-toggle="modal" onclick="edit_recurring_data(id)" id="<?= $row->recurring_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit schedule" data-placement="bottom"></i></span></a></li>
                                            <li><a onclick="del_client(id)" id="<?= $row->recurring_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete schedule" data-placement="bottom"></i></span></a></li>
                                        </ul>
                                    </td>
                                </tr>
                            <?php $count++;
