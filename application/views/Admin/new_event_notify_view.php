    ...
    <div class="col-lg-12 p-0">
        <div class="card">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">	
                <span class="span-py-10 white-text">Event Notify</span>
                <a <?= $AddClassP ?> data-toggle="modal" data-target="#addeventnotify" class="btn btn-link btn-float has-text"><i class="icon-file-plus text-primary"><span class="left-padding">Add</span></i></a>
            </div>
            ...
            <table class="table table-striped" id="MyNotifyByTable">
                ...
                <?php
                    ...
                    foreach ($get_event_notify_report as $row) 
                    {
                        if ($count % 2 == 0) 
                        {
                                    ...
                                    <li>  
                                        <div>
                                            ...
                                            <div class="my-popover-content" style="display:none">
                                                <ul>
                                                    <li>
                                                        <a data-toggle="modal" onclick="edit_event_notify(id)" id="<?= $row->id; ?>" style="color:#333333;">
                                                            <span class="status-mark position-left dot dot-green"></span> Edit Event Notify
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->id ?>" id="<?= $row->id; ?>" style="color:#333333;">
                                                            <span class="status-mark position-left dot dot-red"></span> Delete Event Notify
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
...
<div id="addTimeSlotModule" class="modal fade" data-keyboard="false" data-backdrop="static" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
                <h6 class="card-title py-sm-4 card-headings">Edit Event Notify</h6>
...
<script>
    function edit_event_notify(id) {
        var datastring = 'event_notify_id=' + id;
        //alert(datastring);
        $.ajax({
            type: "post",
            url: "<?php echo base_url('admin/Master/edit_event_notify'); ?>",
            cache: false,
            data: datastring,
            success: function(data) {
...
<div class="modal fade" id="deleteconfirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with deleting this Event Notify?</div>
                <div class="modal-footer" style="justify-content: center;">
                    <form class="form-horizontal" id="deleteEventNotifyForm">
...
<div class="modal fade" id="deactivateconfirmationModal" tabindex="-1" aria-labelledby="deactivateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with inactivating this Event Notify?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<div class="modal fade" id="activateconfirmationModal" tabindex="-1" aria-labelledby="activateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with activating this Event Notify?</div>
                <div class="modal-footer" style="justify-content: center;">
...
$(document).ready(function(e) 
{
  $("#deactivateForm").on('submit', (function(e) 
  {
    ...
    else 
    {
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url('admin/Master/event_notify_deactivate'); ?>",
          cache: false,
          data: { "event_notify_id": datastring },
          success: function(data) {
            $(function() {
...
$(document).ready(function(e) 
{
  $("#activateForm").on('submit', (function(e) 
  {
    ...
    else 
    {
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url('admin/Master/event_notify_activate'); ?>",
          cache: false,
          data: { "event_notify_id": datastring },
          success: function(data) {
            $(function() {
...
$(document).ready(function(e) 
{
  $("#deleteEventNotifyForm").on('submit', (function(e) 
  {
    //e.preventDefault();
    if (e.isDefaultPrevented()) 
    {
    ...
    else 
    {
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url('admin/Master/delete_event_notify'); ?>",
          cache: false,
          data: { "event_notify_id": datastring },
          success: function(data) {
