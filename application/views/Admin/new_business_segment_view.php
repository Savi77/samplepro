...
<style>
   ...
   .popover-body{
    ...
    tr.bg {
     ...
     #MyBusinessSegmentTitle_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(1),#MyBusinessSegmentTitle_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(2),#MyBusinessSegmentTitle_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(3){
        display: none;
    }
    #MyBusinessSegmentTitle th:first-child{
    ...
    <div class="col-lg-12 p-0">
        <div class="card">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">	
                <span class="span-py-10 white-text">Business Segment</span>
                <a <?= $AddClassP ?> data-toggle="modal" data-target="#Business-Segment" class="btn btn-link btn-float has-text"><i class="icon-file-plus text-primary"><span class="left-padding">Add</span></i></a>
            </div>
            <!-- datatable-button-flash-basic -->
            <table class="table table-striped" id="MyBusinessSegmentTitle">
                <thead>
                    <tr>
                        <th>Sr No</th>
                        <th>Business Segment Title</th>
                        ...
                        <tr <?= $bg_color ?>>
                            ...
                            <td <?= $StatusClass; ?>><?php if ($row->status == 1) { ?>
                                <div style="width:150px;">
                                    <button type="button" class="green-btn" data-popup="tooltip" title="Click for Inactive" data-placement="bottom" data-original-title="Click for Inactive" id="<?= $row->business_id ?>" onclick="deactivate(this)" data-id="<?= $row->business_id ?>"> Active </button>
                                    <?php } else { ?>
                                        <button type="button" class="red-btn" data-popup="tooltip" title="Click for Activate" data-placement="bottom" data-original-title="Click for Activate" id="<?= $row->business_id ?>" onclick="activate(this)" data-id="<?= $row->business_id ?>"> Inactive </button>
                                    <?php } ?> 
                                </div>
                            </td>
                            ...
                            <!-- <td>
                                <div class="d-flex">
                                    <a class="cursor-pointer" data-toggle="modal" onclick="edit_client(id)" id="<?= $row->business_id; ?>" data-popup="tooltip" title="Edit Business Segment" data-placement="bottom" data-original-title="Edit Business Segment" <?= $EditClass; ?>><i class="fa fa-edit"></i></a>

                                    <a <?= $DeleteClass; ?> class="cursor-pointer" data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->business_id ?>" id="<?= $row->business_id; ?>" data-popup="tooltip" title="Delete Business Segment" data-placement="bottom" data-original-title="Delete Business Segment"><i class="fa fa-trash"></i></a>
                                </div>
                            </td> -->
                                        ...
                                        <li>  
                                            <div>
                                                ...
                                                <div class="my-popover-content" style="display:none">
                                                    <ul>
                                                        <li>
                                                            <a data-toggle="modal" onclick="edit_client(id)" id="<?= $row->business_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-green"></span> Edit Business Segment  
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->business_id ?>" id="<?= $row->business_id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-red"></span> Delete Business Segment  
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
...
<div id="Business-Segment" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
...
<div id="modal_default1" class="modal fade" data-keyboard="false" data-backdrop="static" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
                <h6 class="card-title py-sm-4 card-headings">Edit Business Segment</h6>
...
<div class="modal fade" id="deleteconfirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with deleting this Business Segment?</div>
                <div class="modal-footer" style="justify-content: center;">
                    <form class="form-horizontal" id="deletebusinessForm">
...
<div class="modal fade" id="deactivateconfirmationModal" tabindex="-1" aria-labelledby="deactivateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with inactivating this Business Segment?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<div class="modal fade" id="activateconfirmationModal" tabindex="-1" aria-labelledby="activateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with activating this Business Segment?</div>
                <div class="modal-footer" style="justify-content: center;">
...
$(document).ready(function(e) 
{
  $("#deletebusinessForm").on('submit', (function(e) 
  {
    //e.preventDefault();
    if (e.isDefaultPrevented()) 
    {
...
<script>
    $(document).ready(function(){
        var rescheduleTable = $('#MyBusinessSegmentTitle').DataTable( {       
        scrollCollapse: true,
        paging:         true, 
        // order: [[0, 'desc']],
        // fixedColumns: true,
