           ...
           {  
             ...
             if (e.isDefaultPrevented())
              ...
              else
              {
                  ...
                  $.ajax({
                    url: "<?php echo base_url('admin/FeatureList/AddDetails'); ?>",
                    type: "POST",
...
function EditDetails(component_id)
{
    ...
    //alert(datastring);
     $.ajax({
      type: "post",
      url: "<?php echo base_url('admin/FeatureList/EditDetails'); ?>",
      cache: false,    
      data: datastring,
      success: function(data)
      {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
             var datastring='component_id='+component_id;
              $.ajax({
              url: '<?php echo base_url('admin/FeatureList/DeleteDetails') ?>',
              type: "POST",
              data:  datastring,
              success: function(data)
                {
