...
<style>
   ...
   .popover-body{
    ...
    #MyProductCategoriesTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(1),#MyProductCategoriesTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(2),#MyProductCategoriesTable_wrapper button.dt-button.buttons-columnVisibility:nth-last-child(3){
        display: none;
    }
    tr.bg {
    ...
    #MyProductCategoriesTable th:first-child{
    ...
    <div class="col-lg-12 p-0">
        <div class="card">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card ">	
                <span class="span-py-10 white-text">Product Categories</span>
                <?php if ($this->session->user_type == 'SA') { ?>
                    <a <?= $AddClassP ?> data-toggle="modal" data-target="#Product-Categories" class="btn btn-link btn-float has-text"><i class="icon-file-plus text-primary"><span class="left-padding">Add</span></i></a>
                <?php } else {    ?>
                    <a <?= $AddClassP ?> data-toggle="modal" data-target="#Product-Categories" class="btn btn-link btn-float has-text"><i class="icon-file-plus text-primary"><span class="left-padding">Add</span></i></a>
                <?php   }   ?>
            ...
            <table class="table table-striped" id="MyProductCategoriesTable">
                <thead>
                    <tr>
                        <th>Sr No</th>
                        <th>Name</th>
                    ...
                    ?>
                        <tr <?= $bg_color_class ?>>
                            ...
                            <!-- <td class="text-center">
                                <div class="row">
                                    <a class="cursor-pointer" data-toggle="modal" onclick="edit_interest(id)" id="<?= $row->id; ?>" data-popup="tooltip" title="Edit schedule" data-placement="bottom" data-original-title="Edit schedule" <?= $EditClass; ?>><i class="fa fa-edit"></i></a>
                                    <a <?= $DeleteClass; ?> class="cursor-pointer" data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->id ?>"  id="<?= $row->id; ?>" data-popup="tooltip" title="Delete Product Catagory" data-placement="bottom" data-original-title="Delete Product Catagory"><i class="fa fa-trash"></i></a>
                                        ...
                                        <li>  
                                            <div>
                                                ...
                                                <div class="my-popover-content" style="display:none">
                                                    <ul>
                                                        <li>
                                                            <a data-toggle="modal" onclick="edit_interest(id)" id="<?= $row->id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-green"></span> Edit Product Category 
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a data-toggle="modal" onclick="DeleteList(this)" data-id="<?= $row->id ?>"  id="<?= $row->id; ?>" style="color:#333333;">
                                                                <span class="status-mark position-left dot dot-red"></span> Delete Product Category 
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
...
<div id="Product-Categories" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
...
<div id="modal_default1" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="card-header header-elements-sm-inline py-sm-0 blue-color-card">
                <h6 class="card-title py-sm-4 card-headings">Edit Product Categories</h6>
...
$(document).ready(function(e) 
{
  $("#deleteprdcategoryForm").on('submit', (function(e) 
  {
    //e.preventDefault();
    if (e.isDefaultPrevented()) 
    {
...
<div class="modal fade" id="deleteconfirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with deleting this Product Category?</div>
                <div class="modal-footer" style="justify-content: center;">
                    <form class="form-horizontal" id="deleteprdcategoryForm">
...
<div class="modal fade" id="deactivateconfirmationModal" tabindex="-1" aria-labelledby="deactivateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with inactivating this Product Category?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<div class="modal fade" id="activateconfirmationModal" tabindex="-1" aria-labelledby="activateconfirmationModalLabel" data-keyboard="false" data-backdrop="static" style=" padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="width:400px">
        <div class="modal-content" style="padding: 30px">
            ...
            <div class="modal-body" style="font-size: 18px; text-align: center;">Shall we proceed with activating this Product Category?</div>
                <div class="modal-footer" style="justify-content: center;">
...
<script>
    $(document).ready(function(){
        var rescheduleTable = $('#MyProductCategoriesTable').DataTable( {       
        scrollCollapse: true,
        paging:         true, 
        // order: [[0, 'desc']],
        // fixedColumns: true,
