                                    ...
                                    <div class="col-md-4 m-0 p-2">
                                        <div class="card business-tier">     
                                            <div class="card-block card-body tier-block" style="min-height: 400px;">
                                                ...
                                                <h1 class="text-center tier-price"><span class="currency-sign"><i class="fa fa-inr"></i>&nbsp;</span><span class="currency-base"><?= $price; ?></span><span class="period" style="font-size: 15px;"> /Year</span></h1>
                                                <ul>
                                     ...
                                     <div class="card business-tier" style="margin-top:5px;">  
                                      <div class="card-block card-body tier-block" style="min-height: 400px;">       
                                         <div class="row"> 
                                              ...
                                              <input type="hidden" id="type" value="Paid" />
