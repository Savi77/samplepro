              ...
              <div class="panel-body" style="padding:0px;">
                <div class="tabbable">
                  <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                    <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">Product / Service List<i class="icon-menu7 position-right"></i></a></li>
                ...
                <div class="modal-body">
                  <form class="form-horizontal" id="addform">
                          ...
                          <div class="form-group">
                            <label class="control-label col-sm-2" for="menu_id">Select Category <span style="color: red;">*</span></label>
                            <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter Product Name" maxlength="50">
                            </div>
                          ...
                          <div class="form-group">
                                <!-- <label class="control-label col-sm-2" for="email">Product Specs </label>
                                    <div class="col-sm-4">
                                      <select class="select-search form-control" name="prd_specs" id="prd_specs">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <textarea class="form-control" id="prd_srv_description" name="prd_srv_description" placeholder="Enter Description" maxlength="500"></textarea>
