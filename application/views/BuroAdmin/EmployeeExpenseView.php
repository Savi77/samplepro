                      ...
                      <div class="tabbable">
                        <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#00619F;">
                          <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">
                            <i class="icon-coins position-right" style="zoom:1.4;"></i>&nbsp; Expenses</a></li>
                        </ul>
    ...
    function  EditExpenseDetails(REFID)
      {
        ...
        $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/Expense/EditExpenseDetails'); ?>",
                data: datastring,
                success: function(data)
                {    
           ...
           $("#addform").on('submit',(function(e)
               {
                 if (e.isDefaultPrevented())
                  ...
                  {
                      $("#preview2").html('<img src="<?= base_url() ?>assets/images/default.gif" style="height:30px;width:30px;" alt="sending data...."/>');
                      $("#preview2").show();                     
                          $.ajax({
    ...
    $( document ).ready(function() 
      {
        ...
        $('#employee_grid').DataTable({
           ...
           "language": 
            ...
            "ajax":{
                      url: "<?php echo base_url('admin/Expense/EmployeeAjaxData');?>",
                      type: "post", 
                      error: function()
                      {
