              ...
              <div class="panel-body" style="padding:0px;">
                <div class="tabbable">
                  <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                    <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab"  style="font-size: 18px;color: white;"><i class="icon- icon-magic-wand position-left"></i>&nbsp;Feature List</a></li>
                    <li><a href="#right-icon-tab2" data-toggle="tab" style="font-size: 18px;color: white;"><i class=" icon-profile position-right"></i>&nbsp;&nbsp;Feature Description </a></li>
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    {   
                        $.ajax({
                           ...
                           url: "<?php echo base_url('BA/Feature/add');?>",
                                  type: "POST",
                                  ...
                                  success: function(data)
                                   {
                                    ...
                                    // $("#inner_page_desc").val('');
                                     ...
                                     new PNotify({
                                             ...
                                             setTimeout(function()
                                               {
                                                   window.location="<?php echo base_url('BA/Feature');?>";
                                               }, 1000);
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Feature/deactivate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Feature/activate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('BA/Feature/Update_header');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Feature/delete_feature'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
...
<script>
    function edit_feature(id)
    {
        ...
        //alert(datastring);
         $.ajax({
          type: "post",
          url: "<?php echo base_url('BA/Feature/edit_feature'); ?>",
          cache: false,    
          data: datastring,
          success: function(data)
          {    
