  ...
  <div class="page-header">
    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Slider</span></h4>
      </div>
              ...
              <div class="panel-body" style="padding:0px;">
                <div class="tabbable">
                  <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                    <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab" style="color: white;"><i class="icon-image4 position-right"></i> &nbsp;Slider List</a></li>
                        ...
                        <tbody>
                             ...
                             <?php
                              ...
                              <tr>
                                ...
                                <td><img  class="img-thum" style="height:32px;width:32px;" src="<?= base_url() ?>assets/admin/assets/images/slider/<?= $row->image ?>"></td>             
                                <td><?= $row->title ?></td>
                                ...
                                <td>
                                   <ul class="icons-list">
                                      <li><a  onclick="edit_slider(id)" id="<?= $row->id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Slider" data-placement="bottom"></i></span></a></li>
                                      <li><a onclick="del_slider(id)" id="<?= $row->id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Slider" data-placement="bottom"></i></span></a></li>
                                    </ul>
                                </td>
                              </tr>
                            <?php $count++; } ?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header bg-info" style="background-color:#009FDF;">
                  ...
                  <h6 class="modal-title"> Add Slider </h6>
                </div>
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    {   
                        $.ajax({
                           ...
                           url: "<?php echo base_url('BA/Slider/add');?>",
                                  type: "POST",
                                  ...
                                  success: function(data)
                                   {
                                    ...
                                    // $("#inner_page_desc").val('');
                                     ...
                                     new PNotify({
                                             ...
                                             setTimeout(function()
                                               {
                                                   window.location="<?php echo base_url('BA/Slider');?>";
                                               }, 1000);
...
<script>
    function deactivate(id)
    {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to Inactive this Slider?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Slider/deactivate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
...
<script>
    function activate(id)
    {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to activate this Slider?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Slider/activate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('BA/Slider/Update_header');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
...
<script>
    function del_slider(id)
    {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to delete this Slider?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Slider/delete_slider'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
...
<script>
    function edit_slider(id)
    {
        ...
        //alert(datastring);
         $.ajax({
          type: "post",
          url: "<?php echo base_url('BA/Slider/edit_slider'); ?>",
          cache: false,    
          data: datastring,
          success: function(data)
          {    
