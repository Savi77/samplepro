                 ...
                 {  
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    else
                    {
                        ...
                        $.ajax({
                           url: "<?php echo base_url('BA/Testimonial/Add_Testimonial');?>",
                          type: "POST",
                          ...
                          success: function(data)
                            {
                                 ...
                                 setTimeout(function()
                                   {
                                       window.location="<?php echo base_url('BA/Testimonial');?>";
                                   }, 1000);
       ...
       notice.get().on('pnotify.confirm', function()
         {
            ...
            //alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Testimonial/testimonial_delete'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('BA/Testimonial/Update_header');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
...
<script>
    function edit_testimonial(id)
    {
      ...
      //alert(datastring);
       $.ajax({
        type: "post",
        url: "<?php echo base_url('BA/Testimonial/edit_Testimonial'); ?>",
        cache: false,    
        data: datastring,
        success: function(data)
        {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Testimonial/deactivate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/Testimonial/activate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
