                      ...
                      <div class="tabbable">
                        <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#00619F;">
                          <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">
                            <i class="icon-make-group position-right" style="zoom:1.4;"></i> &nbsp; Module List</a></li>
                        </ul>
                                          ...
                                          <?php 
                                            ...
                                            ?>
                                              <tr>
                                                ...
                                                <td>
                                                    <ul class="icons-list">
                                                        <li><a data-toggle="modal" onclick="EditDetails(id)" id="<?= $row['module_id']; ?>">
                                                        ...
                                                        <li><a data-toggle="modal" onclick="DeleteDetails(id)" id="<?= $row['module_id']; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete" data-placement="bottom"></i></span></a></li>
                                                    </ul>
                                                </td>
                                              </tr>
                                          <?php $count++; } ?>
                              ...
                              <div class="col-md-12"> 
                                <div class="form-group">
                                   <label>Module Title : <sup style="color: red">*</sup></label>
                                    <input type="text" class="form-control" name="module_name" autocomplete="off">
                                </div>
                              </div>          
                          </div>
                        </fieldset>  
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="multi-select-full">
                                    <select class="multiselect-select-all" multiple="multiple" name="component_ids[]">
                                        <?php   
                                          foreach ($component_list as $res) 
                                          {
                                        ?>
                                        <option value="<?= $res->component_id;?>"><?= $res->component_title;?></option>
                                       <?php } ?> 
                                    </select>
                                  </div>
                                </div>
           ...
           {  
             ...
             if (e.isDefaultPrevented())
              ...
              else
              {
                  ...
                  $.ajax({
                    url: "<?php echo base_url('BA/Module/AddDetails'); ?>",
                    type: "POST",
                    ...
                    success: function(data)
                      {
                        ...
                        // alert(data);
                         $(function()
                         {
                           ...
                           setTimeout(function()
                             {
                                 window.location="<?php echo base_url('BA/Module');?>";
                             }, 1000);
                      },
                      error: function() 
                      {
...
<script>
function EditDetails(module_id)
{
    $(window).scrollTop(0);
    ...
    // alert(datastring);
     $.ajax({
      type: "post",
      url: "<?php echo base_url('BA/Module/EditDetails'); ?>",
      cache: false,    
      data: datastring,
      success: function(data)
      {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
             var datastring='module_id='+module_id;
              $.ajax({
              url: '<?php echo base_url('BA/Module/DeleteDetails') ?>',
              type: "POST",
              data:  datastring,
              success: function(data)
                {
