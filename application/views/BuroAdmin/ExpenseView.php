    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span class="text-semibold">Home</span></a> - Expense
        </h4>
      </div>
                      ...
                      <div class="tabbable">
                        <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#00619F;">
                          <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">
                            <i class="icon-coins position-right" style="zoom:1.4;"></i> Expense List</a></li>
                        </ul>
                                        ...
                                        <?php 
                                          ...
                                          ?>
                                            <tr>
                                              ...
                                              <td>
                                                  <ul class="icons-list">
                                                      <li><a data-toggle="modal" onclick="edit_expense(id)" id="<?= $row->expense_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Expense" data-placement="bottom"></i></span></a></li>
                                                      <li><a data-toggle="modal" onclick="delete_expense(id)" id="<?= $row->expense_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Expense" data-placement="bottom"></i></span></a></li>
                                                  </ul>
                                              </td>
                                            </tr>
                                        <?php $count++; } ?>
