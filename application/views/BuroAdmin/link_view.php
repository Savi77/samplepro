              ...
              <div class="panel-body" style="padding:0px;">
                <div class="tabbable">
                  <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                    <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab" style="color: white;" ><i class="icon-menu7 position-right"></i>&nbsp;Play Store Link</a></li>
                    <li><a href="#right-icon-tab2" data-toggle="tab" style="font-size: 18px;color: white;">Play Store Description</i></a></li>
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('BA/Link/Update_link');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
                                ...
                                success: function(data)
                                 {
                                   new PNotify({
                                           ...
                                           setTimeout(function()
                                             {
                                                 window.location="<?php echo base_url('BA/Link');?>";
                                             }, 1000);
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('BA/Link/Update_header');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
