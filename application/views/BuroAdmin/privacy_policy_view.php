    ...
    <div class="page-header">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Privacy Policy</span> - Manage</h4>
            </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Privacy Policy</h5>   
                    </div>
                    <hr style="margin: 0;">
                    <?php if (!empty($Privacy_Policy_Data)) { ?>
                        <form class="form-horizontal" id="UpdatePrivacyPolicyFrom" style="padding: 5px 30px;" method="POST">
                            <input type="hidden" name="policies_type" value="<?= $Privacy_Policy_Data->policies_type?>">
                            <input type="hidden" name="policies_id" value="<?= $Privacy_Policy_Data->policies_id?>">
                            <div class="form-group" style="padding-top: 20px;">
                                <div class="col-sm-12">
                                    <textarea name="description" id="description" rows="4" cols="4" required> <?= $Privacy_Policy_Data->policies_section?> </textarea>
                                </div>
                            </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            new PNotify({
                                ...
                                text: 'Update Privacy Policy Successfully!',
                                type: 'success',
                                addclass: 'pnotify-center'
                            });

                            setTimeout(function() {
                                window.location = "<?php echo base_url('BA/Policies'); ?>";
                            }, 1000);
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            new PNotify({
                                title: 'Add Policies',
                                text: 'Add Privacy Policy Successfully!',
                                type: 'success',
                                addclass: 'pnotify-center'
                            });
