...
<body>
  ...
  <div class="page-header">
    <div class="breadcrumb-line breadcrumb-line-wide">
      <ul class="breadcrumb">
        ...
        <li class="active">Creative Features</li>
      </ul>
    </div>
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Creative Features</span></h4>
      </div>
          ...
          <div class="panel-body" style="padding:0px;">
            <div class="tabbable">
              <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">Creative Features List<i class="icon-menu7 position-right"></i></a></li>
                <li><a href="#right-icon-tab2" data-toggle="tab" style="font-size: 18px;">Creative Features Description</i></a></li>
                    ...
                    <tbody>
                      ...
                      foreach ($get_list as $row) { ?>
                        <tr>
                          ...
                          <td><img class="img-thum" style="height:32px;width:32px;" src="<?= base_url() ?>assets/admin/assets/images/creative_features/<?= $row->image ?>"></td>
                          <td><?= $row->title ?></td>
                          ...
                          <td>
                            <ul class="icons-list">
                              <li><a onclick="edit_work(id)" id="<?= $row->id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit How we work" data-placement="bottom"></i></span></a></li>
                              <li><a onclick="del_work(id)" id="<?= $row->id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete How we work" data-placement="bottom"></i></span></a></li>
                            </ul>
                          </td>
                        </tr>
                      <?php $count++;
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-info" style="background-color:#009FDF;">
          ...
          <h6 class="modal-title"> Add Creative Features </h6>
        </div>
  ...
  <div id="modal_default" class="modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-info" style="background-color:#009FDF;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h6 class="modal-title">Edit Creative Features</h6>
        </div>
      ...
      $("#addform").on('submit', (function(e) {
        ...
        if (e.isDefaultPrevented()) {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('BA/Creative_Features/add'); ?>",
            type: "POST",
            ...
            success: function(data) {
              ...
              setTimeout(function() {
                window.location = "<?php echo base_url('BA/Creative_Features'); ?>";
              }, 1000);
  ...
  <script>
    function deactivate(id) {
      ...
      notice.get().on('pnotify.confirm', function() {
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url('BA/Creative_Features/deactivate'); ?>",
          cache: false,
          data: datastring,
          success: function(data) {
            // alert(data);
  ...
  <script>
    function activate(id) {
      ...
      notice.get().on('pnotify.confirm', function() {
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url('BA/Creative_Features/activate'); ?>",
          cache: false,
          data: datastring,
          success: function(data) {
            //alert(data);
      ...
      $("#sectionform").on('submit', (function(e) {
        if (e.isDefaultPrevented()) {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('BA/Creative_Features/Update_header'); ?>",
            type: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
  ...
  <script>
    function del_work(id) {
      ...
      notice.get().on('pnotify.confirm', function() {
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url('BA/Creative_Features/delete_work'); ?>",
          cache: false,
          data: datastring,
          success: function(data) {
            //alert(data);
  ...
  <script>
    function edit_work(id) {
      ...
      $.ajax({
        type: "post",
        url: "<?php echo base_url('BA/Creative_Features/edit_work'); ?>",
        cache: false,
        data: datastring,
        success: function(data) {
          //alert(data);
