 ...
 ?>
          <form class="form-horizontal" id="EditCustomerForm">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <textarea class="form-control" id="address3" name="address" placeholder="Enter address" maxlength="200"><?= $row1->address ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group"> 
                  <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-primary pull-right">Convert To Contact  <i class="icon-arrow-right14 position-right"></i></button>
                  </div>
                </div>
            </form>
<?php } ?>
