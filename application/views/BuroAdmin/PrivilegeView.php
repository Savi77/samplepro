                              ...
                              <div class="col-md-12"> 
                                <div class="form-group">
                                   <label>Privilege Key : <sup style="color: red">*</sup></label>
                                    <input type="text" class="form-control" name="privilege_key" placeholder="E.g. ADD,...">
                                </div>
                              </div>  
                          </div>
                        </fieldset>                                              
       ...
       $("#addform").on('submit',(function(e)
           {  
             ...
             if (e.isDefaultPrevented())
              ...
              {
                  $.ajax({
                    url: "<?php echo base_url('BA/Privilege/add_privilege'); ?>",
                    type: "POST",
...
function EditDetails(privilege_id)
{
    ...
    //alert(datastring);
     $.ajax({
      type: "post",
      url: "<?php echo base_url('BA/Privilege/EditDetails'); ?>",
      cache: false,    
      data: datastring,
      success: function(data)
      {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
             var datastring='privilege_id='+privilege_id;
              $.ajax({
              url: '<?php echo base_url('BA/Privilege/DeleteDetails') ?>',
              type: "POST",
              data:  datastring,
              success: function(data)
                {
