                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active modal-body" id="right-icon-tab1">                                    
                                    <form class="form-horizontal" id="EditWorkFormService" enctype="multipart/form-data" action="<?php echo base_url('BA/Service_Feature/add'); ?>" method="POST">
                                                ...
                                                <fieldset class="scheduler-border">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="tilte_one" id="tilte_one" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" id="detail_content_one" name="detail_content_one"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="tilte_two" id="tilte_two" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" id="detail_content_two" name="detail_content_two"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="tilte_three" id="tilte_three" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" id="detail_content_three" name="detail_content_three"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="tilte_four" id="tilte_four" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" id="detail_content_four" name="detail_content_four"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="title_five" id="title_five" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" id="detail_content_five" name="detail_content_five"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="title_six" id="title_six" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" id="detail_content_six" name="detail_content_six"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            new PNotify({
                                title: 'ADD Record',
                                text: 'Service Feature Added Successfully',
                                type: 'success'
                            });
