    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span class="text-semibold">Home</span></a> - Location List
        </h4>
      </div>
                     ...
                     <?php
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                               <ul class="icons-list">
                                  <li><a data-toggle="modal" onclick="edit_client(id)" id="<?= $row->location_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Location" data-placement="bottom"></i></span></a></li>

                                  <li><a onclick="del_client(id)" id="<?= $row->location_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Location" data-placement="bottom"></i></span></a></li>
