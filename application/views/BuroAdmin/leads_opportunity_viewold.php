...
<body style="overflow-x: hidden;">
  ...
  <!-- /page header -->
				...
				<div class="row">
                    ...
                    <th>Closure Date</th>										
                        ...
                        <td class="text-center" style="width: 30%;">
                           <ul class="icons-list">
                                <li><a onclick="del_leads(id)" id="<?= $row['leadopp_id'] ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Leads Opportunity" data-placement="bottom"></i></span></a></li>
                               <?php
                                if($row['customer_type']=='Lead')
                                {
                               ?>
                                 <li><a onclick="convert_to_contact(id)" id="<?= $row['leadopp_id'] ?>">
                                  <span class="label bg-info" style="line-height: 20px;">
                                    <i class="glyphicon glyphicon-user" style="font-size: 12px;" data-toggle="tooltip" title="Convert To Contact" data-placement="bottom"></i>
                                  </span></a>
                                </li>
                              <?php } ?>  
                                 <li><a onclick="Transfer_Lead(id)" id="<?= $row['leadopp_id'] ?>">
                                  <span class="label bg-primary" style="line-height: 20px;">
                                    <i class="icon-drag-right" style="font-size: 12px;" data-toggle="tooltip" title="Transfer Lead" data-placement="bottom"></i>
                                  </span></a>
                                </li>
                                 <li><a href="<?= base_url('admin/Customer/AddActivityTask')?>?<?= $taskparameter?>" >
                                  <span class="label bg-success" style="line-height: 20px;">
                                    <i class=" icon-clipboard6" style="font-size: 12px;" data-toggle="tooltip" title="Add Activity Task" data-placement="bottom"></i>
                                  </span></a>
                                </li>   
                                 <li><a onclick="AddAttachment(id)" id="<?= $row['leadopp_id'];?>">
                                  <span class="label bg-teal" style="line-height: 20px;">
                                    <i class="icon-upload" style="font-size: 12px;" data-toggle="tooltip" title="Add Attachment" data-placement="bottom"></i>
                                  </span></a>
                                </li>  
                           </ul>
                        </td>
                        ...
                        <td><?= $row['customer_type'] ?></td>
												<td>
                           <?php
                            if($row['closure_date']=='0000-00-00' || $row['closure_date']=='1970-01-01')
                            { echo 'NA'; }else{
                           ?>
                                  ...
                                  <div class="panel-body">
                                          ...
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Contact Number :  <sup style="color: red">*</sup></label>
                                                 <input type="text" class="form-control"  name="contact_number1" placeholder="Enter contact number" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 43 || event.charCode == 45' maxlength="15"  autocomplete="off">
                                            </div>
                                          </div> 
                                      </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                      <div class="row">
                                          ...
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>City : </label>
                                                <input type="text" class="form-control" name="city" placeholder="Enter City" maxlength="50">
                                            </div>
                                          </div>
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                                 ...
                                                 <select name="location"  class=" form-control" >
                                                      <option value="">Select Location</option>
                                                        <?php   
                                                          ...
                                                          {
                                                        ?>
                                                        <option value="<?= $value3->location ?>"><?= $value3->location;?></option>
                                                       <?php } ?> 
                                                  </select>
                                            </div>
                                          </div>    
                                          ...
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Closure Date  : </label>
                                                  <input type="text" class="form-control" id="closure_date" name="closure_date" placeholder="Select Closure Date" maxlength="50">
                                            </div>
                                          </div> 
                                        </div>
                                    </fieldset>  
                                    ...
                                    <fieldset>
                                      <div class="row">
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Project Business Value : </label>
                                                <input type="text" class="form-control"  name="project_business_value" placeholder="Enter Business Value" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 43 || event.charCode == 45'  autocomplete="off">
                                            </div>
                                          </div>   
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                    ...
                                    <fieldset>
                                      <div class="row">
                                          <div class="col-md-12"> 
                                            <div class="form-group">
                                               <label>Remark : </label>
                                               <textarea class="form-control"  id="remarkslead"   name="remarks" placeholder="Enter Remark" rows="3"  maxlength="500" ></textarea>  
                                    ...
                                    <fieldset>
                                      <div class="row">
                                          ...
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Contact Person : </label>
                                                 <input type="text" class="form-control" id="contact_person2"  name="contact_person" placeholder="Contact person name" maxlength="50"  autocomplete="off">
                                            </div>
                                          </div>   
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                      ...
                                      <div class="row">
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               ...
                                               <span id="opp_emp_id_error" style="color: red;display:none;">Please Select Employee</span>                                                                                  
                                             </div>
                                          </div>  
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>City : </label>
                                                <input type="text" class="form-control" id="city1" name="city" placeholder="City" maxlength="50">
                                            </div>
                                          </div> 
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Email ID : </label>
                                                <input type="text" class="form-control" name="email_id" id="email_id2"  placeholder="Email" maxlength="35"  autocomplete="off">
                                            </div>
                                          </div>     
                                       </div>
                                    </fieldset> 
                                    ...
                                    <fieldset>
                                      <div class="row">
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Location : </label>
                                                <input type="text" class="form-control" id="location_opp" name="location1" placeholder="Location" maxlength="35">
                                            </div>
                                          </div>  
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Address : </label>
                                                 <textarea class="form-control"  id="address2"  name="address" placeholder="Enter address" rows="1" ></textarea>
                                            </div>
                                          </div> 
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                    ...
                                    <fieldset>
                                      <div class="row">
                                          ...
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Business Segment : </label>
                                                 <input type="text" class="form-control" id="business_opp" name="business1" placeholder="Business" maxlength="35">
                                            </div>
                                          </div>
                                          <div class="col-md-4"> 
                                            <div class="form-group">
                                               <label>Group : </label>
                                                <input type="text" class="form-control" id="group_opp" name="group1" placeholder="Group" maxlength="35">
                                            </div>
                                          </div>    
                                      </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                      <div class="row">
                                          <div class="col-md-12"> 
                                            <div class="form-group">
                                               <label>Remark : </label>
                                               <textarea class="form-control" id="remarksopp" name="remarks" placeholder="Enter Remark" rows="3" maxlength="500"></textarea>  
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <span style="font-size:13px; ">Max: 500 character</span>
                                                    </div>
    ...
    <script type="text/javascript">
      $(function () 
      {
          $('#closure_date').datetimepicker({format: 'DD MMMM, YYYY',maxDate: 'now', useCurrent: true});
          $('#closure_date1').datetimepicker({format: 'DD MMMM, YYYY',maxDate: 'now', useCurrent: true});
      });
    </script>
