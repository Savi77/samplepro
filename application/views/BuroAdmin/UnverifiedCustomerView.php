                      ...
                      <div class="tabbable">
                        <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#00619F;">
                          <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">
                            <i class="icon-user-check position-right" style="zoom:1.4;"></i> &nbsp; Unverified Customer</a></li>
                        </ul>
                        <div class="tab-content">
                          <div class="tab-pane active" id="right-icon-tab1">
                            <table class="table datatable-responsive">
                              ...
                              <thead>  
                              <tr>
                                  <th class="d-none" style="display:none;"></th> 
                                  <th class="d-none" style="display:none;"></th> 
                                  <th class="d-none" style="display:none;"></th> 
                                  <th class="d-none" style="display:none;"></th> 
                                  <th style="width: 15px;padding-left: 55px;">#</th>
                                  <th class="sorting" style="width: 15px;padding-left: 55px;">Company Name</th>
                              </tr>  
                              </thead>
                              <tbody>
                              <?php 
                                ...
                                ?>
                                  <tr> 
                                    ...
                                    <td class="d-none" style="display:none;"></td> 
                                    <td class="d-none" style="display:none;"></td> 
                                    <td style="width: 15px;padding-left: 55px;"><?php echo $count ?></td>
                                    <td style="width: 15px;padding-left: 55px;"><?= $row->email; ?></td>
                                  </tr>
                              <?php $count++; } ?>
                              </tbody>
                            </table>
