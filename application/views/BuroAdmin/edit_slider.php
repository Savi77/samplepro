...
<?php foreach ($edit_slider->result() as $value) 
  {
?>
              <form class="form-horizontal" id="EditWorkForm" enctype="multipart/form-data">
                <input type="hidden" class="form-control" id="slider_id" name="slider_id" placeholder="Enter Language" value="<?= $value->id ?>">
                  ...
                  <div class="col-lg-9">
                    <div class="media no-margin-top">
                      <div class="media-left">
                        <a href="#"><img src="<?= base_url() ?>assets/admin/assets/images/slider/<?= $value->image ?>" style="width: 58px; height: 58px;" class="img-rounded" alt="" id="blah1"></a>
                      </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="title_description" name="title_description" placeholder="Please Enter Description" value="<?= $value->description ?>" maxlength="150">
                  </div>
                </div>
                <div class="form-group"> 
                 ...
                 {  
                   ...
                   if (e.isDefaultPrevented())
                    ...
                    else
                    {
                              ...
                              $.ajax({
                                 url: "<?php echo base_url('BA/Slider/update');?>",
                                type: "POST",
