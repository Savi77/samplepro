                   ...
                   if (e.isDefaultPrevented())
                    ...
                    {   
                        $.ajax({
                           ...
                           url: "<?php echo base_url('BA/How_we_work/add');?>",
                                  type: "POST",
                                  ...
                                  success: function(data)
                                   {
                                    ...
                                    // $("#inner_page_desc").val('');
                                     ...
                                     new PNotify({
                                             ...
                                             setTimeout(function()
                                               {
                                                   window.location="<?php echo base_url('BA/How_we_work');?>";
                                               }, 1000);
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/How_we_work/deactivate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/How_we_work/activate'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
            ...
            {   
              // alert();
                $.ajax({
                         ...
                         url: "<?php echo base_url('BA/How_we_work/Update_header');?>",
                                type: "POST",
                                data:  new FormData(this),
                                contentType: false,
                                cache: false,
        ...
        notice.get().on('pnotify.confirm', function()
         {
           ...
           // alert(datastring);
             $.ajax({
              type: "post",
              url: "<?php echo base_url('BA/How_we_work/delete_work'); ?>",
              cache: false,    
              data: datastring,
              success: function(data)
              {    
...
<script>
    function edit_work(id)
    {
        ...
        //alert(datastring);
         $.ajax({
          type: "post",
          url: "<?php echo base_url('BA/How_we_work/edit_work'); ?>",
          cache: false,    
          data: datastring,
          success: function(data)
          {    
