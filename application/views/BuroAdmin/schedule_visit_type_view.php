    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span class="text-semibold">Home</span></a> - Schedule Visit Type List
        </h4>
      </div>
        ...
        <!-- Basic responsive configuration -->
            <div class="panel panel-flat" >
              <div class="panel-heading table_header">
                <h5 class="panel-title" style="color:white">Schedule Visit List</h5>
                <div class="heading-elements">
                  <td> 
                     ...
                     <?php
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                               <ul class="icons-list">
                                  <li><a data-toggle="modal" onclick="edit_client(id)" id="<?= $row->id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit type" data-placement="bottom"></i></span></a></li>

                                  <li><a onclick="del_client(id)" id="<?= $row->id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete type" data-placement="bottom"></i></span></a></li>
                              </ul>
                            </td>
                          </tr>
                        <?php $count++; } ?>
                    ...
                    <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header bg-info" style="background-color:#009FDF;">
                              ...
                              <h6 class="modal-title"> Add Schedule Visit Type</h6>
                            </div>
                            ...
                            <div class="modal-body">
                              <form class="form-horizontal" id="ScheduleForm">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" id="type_name" name="type_name" placeholder="Enter Schedule Visit Type" maxlength="35">
                                    </div>
                                  </div>
             ...
             <div id="modal_default" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header bg-info" style="background-color:#009FDF;">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h6 class="modal-title">Edit Schedule Visit Type</h6>
                      </div>
...
<script>
    function del_client(id)
    {
      ...
      var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to delete this Schedule Visit Type?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
...
<script>
    function deactivate(id)
    {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to Inactive this Schedule Visit Type?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
...
<script>
    function activate(id)
    {
        ...
        var notice = new PNotify({
            title: 'Confirmation',
            text: '<p>Are you sure you want to activate this Schedule Visit Type?</p>',
            hide: false,
            type: 'warning',
            confirm: {
                confirm: true,
