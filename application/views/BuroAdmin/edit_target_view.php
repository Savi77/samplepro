                 ...
                 <form class="form-horizontal" id="editTarget_Form">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                  <input type="text" class="form-control" id="start_date12" name="start_date" value="<?= date("d M Y", strtotime($start_date)); ?>" readonly>
                                </div>
                            ...
                            <div class="form-group" id="selectedemployeelist">
                                    ...
                                    <div class="col-sm-10" style="max-height: 330px; overflow: scroll; overflow-x: hidden;">
                                          <?php foreach ($selected_employee_list as $emp1) 
                                            { 
                                              ?>
                                              <div class="row">
                            ...
                            <div class="form-group" id="issuelistdetails1" style="display: none">
                                  <label class="control-label col-sm-2" for="Youtube">Employee list <span style="color: red;">*</span></label>
                                  <div class="col-sm-10" id="issue_schedule_list1" style="max-height: 330px; overflow: scroll; overflow-x: hidden;">
                      ...
                      <div class="form-group"> 
                        <div class="col-sm-offset-3 col-sm-9">
                          <button type="submit" class="btn btn-primary pull-right" id="desktopbutton12">Submit</button>
                        </div>
                        <div id="loader"></div>
                      </div>
            </form>
