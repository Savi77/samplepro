    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span class="text-semibold">Home</span></a> - Product Categories
        </h4>
      </div>
                        ...
                        <td><?php if($row->status==1){ ?>
                            ...
                            <?php } ?>
												...
												<td class="text-center">
													 <ul class="icons-list">
                              <li><a data-toggle="modal" onclick="edit_interest(id)" id="<?= $row->id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Interest" data-placement="bottom"></i></span></a></li>
                              <li><a onclick="del_interest(id)" id="<?= $row->id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Interest" data-placement="bottom"></i></span></a></li>
             ...
             <div id="modal_default" class="modal fade">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header bg-info" style="background-color:#009FDF;">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h6 class="modal-title">Edit Product Categories</h6>
                            </div>
