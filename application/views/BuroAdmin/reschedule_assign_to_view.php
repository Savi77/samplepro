...
.multiselect-container>li>a>label>input[type=checkbox] 
{
    margin-top: -4px !important;
        ...
        <form class="form-horizontal" id="assignto_form1" method="post">
              ...
              <div class="row">
                 ...
                 <div class="form-group">
                     <label class="control-label col-sm-2" for="Youtube">Employee Name</label>
                      <div class="col-sm-4">
                            <select class="select-search" name="employee_id" id="employee_id1" onchange="getassignedissue1()">
                      ...
                      <label class="control-label col-sm-2" for="email">Schedule Date</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control testing" id="schedule_date1" name="schedule_date" placeholder="Enter Schedule Date"  onchange="getassignedissue1()">
          ...
          <div class="form-group"> 
            <div class="col-sm-2">
              <div id="loader_gif1"></div>
            </div>
            <div class="col-sm-offset-3">
              <button type="submit" class="btn btn-primary pull-right" id="desktopbutton1" onclick="return form_assignto()">Submit</button>
            </div>
          </div>
      </form>
...
function mainInfo11()
{
    ...
    var start_date = $('#schedule_date1').val();
    // alert(start_date);
...
function form_assignto()
{
       ...
       event_end_time = $('#end_time').val();
        ...
        else
        {
          $('#desktopbutton1').prop('disabled', true);
          // alert();
            $("#loader_gif1").html('<img src="<?= base_url() ?>assets/images/default.gif" alt="Uploading...."/>');
            var formresult = $("#assignto_form1").serialize();
               $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/Customer/reschedule_assign_to'); ?>",
                                            ...
                                            notice.get().on('pnotify.confirm', function()
                                             {
                                                    ...
                                                    $.ajax({
                                                               url: "<?php echo base_url('admin/Customer/reschedule_assign_to_override'); ?>",
                                                                type: "POST",
                                                                data:  $("#assignto_form1").serialize(),
                                                                cache: false,
                                                                success: function(data)
...
<script>
    function getassignedissue1()
    {
                 schedule_date = $('#schedule_date1').val();
