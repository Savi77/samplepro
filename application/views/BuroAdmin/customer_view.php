...
<body style="overflow-x: hidden;">
    ...
    <div class="page-header-content">
     ...
     <div class="heading-elements">
        <div class="heading-btn-group">
          <a data-toggle="modal" data-target="#customer_model" class="btn btn-link btn-float has-text" style="<?= $cust_update ?>"><i class="icon-file-plus text-primary"></i><span>ADD</span></a>
        </div>
      </div>
    </div>
  </div>
 ...
 <!-- /basic responsive configuration -->
      ...
      <div id="customer_model" class="modal fade">
                    ...
                    <div class="modal-body">
                      <form class="form-horizontal" id="CustomerForm">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-4" id="parentlist_display">
                              <input type="text" class="form-control" id="ordanizer_name" name="ordanizer_name" placeholder="Enter organization name" maxlength="100">
                            </div>
                             <div class="col-sm-4"  style="display: none" id="forsecondarylist_display">
                            ...
                            <label class="control-label col-sm-2" for="email">
                              Address <a onclick="open_google_map()">( Use Google Address )</a> 
                             <span style="color: red;">*</span></label>
                            <div class="col-sm-4">
                              <textarea class="form-control" id="address" name="address" placeholder="Enter address" maxlength="200"></textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            <label class="control-label col-sm-2" for="email">Password <span style="color: red;">*</span></label>
                            <div class="col-sm-4">
                              <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password" maxlength="35">
                            </div>
                            <label class="control-label col-sm-2" for="email">Confirm Password <span style="color: red;">*</span></label>
                            <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="dob" name="dob" placeholder="Select DOB" maxlength="50">
                            </div>
                            <label class="control-label col-sm-2" for="email">Company Anniversary </label>
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="company_aniversary" name="company_aniversary" placeholder="Select Company Aniversary" maxlength="50" value="">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="marriage_aniversary" name="marriage_aniversary" placeholder="Select Marriage Aniversary" maxlength="50" value="">
                            </div>
                          ...
                          <label class="control-label col-sm-2" for="email">Country <span style="color: red;">*</span></label>
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <select name="business[]" id="business" multiple class="form-control">
