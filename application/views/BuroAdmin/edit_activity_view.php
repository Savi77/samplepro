...
<?php foreach ($editactivity_detail->result() as $value) {
  ?>
        <form class="form-horizontal" id="EditType">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="activity_title" name="activity_title" value="<?= $value->activity_title ?>" placeholder="Enter Activity Title" maxlength="50" >
            </div>
          </div>
