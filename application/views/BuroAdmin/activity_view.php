                     ...
                     <?php
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                               <ul class="icons-list">
                                  <li><a data-toggle="modal" onclick="edit_activity(id)" id="<?= $row->activity_id; ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Activity" data-placement="bottom"></i></span></a></li>
                                  <li><a onclick="del_activity(id)" id="<?= $row->activity_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete Activity" data-placement="bottom"></i></span></a></li>
                               </ul>
                            </td>
                          </tr>
                        <?php $count++; } ?>
                            ...
                            <div class="modal-body">
                              <form class="form-horizontal" id="TargetTypeForm">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" id="activity_title" name="activity_title" placeholder="Enter Activity Title" maxlength="50">
                                    </div>
                                  </div>
