...
<script>
    function Edit_Customer_period(id) 
    {
        var datastring = 'org_id=' + id;
        $.ajax({
        type: "post",
        url: "<?php echo base_url('BA/BuroCustomer/edit_period'); ?>",
        cache: false,    
        data: datastring,
        ...
        {    
          //alert(data);
           ...
           $('#periodchange_model_data').html(data);
    ...
    <div class="page-header-content">
      <div class="page-title">
        <h4>
         ...
         <a href="<?php echo base_url('admin/Dashboard/view_dashboard');?>"> <span class="text-semibold">Home</span></a> - Trial Customer
        </h4>
      </div>
                      ...
                      <div class="tabbable">
                        <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#00619F;">
                          <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">
                            <i class="icon-users2 position-right" style="zoom:1.4;"></i> &nbsp; Trial Customer</a></li>
                        </ul>
                                          ...
                                          <?php 
                                            ...
                                            ?>
                                              <tr>
                                                ...
                                                <td>
                                                <ul class="icons-list">
                                                  <li><a data-toggle="modal" onclick="Edit_Customer_period(id)" id="<?= $row->org_id; ?>" data-id="<?= $row->org_id ?>"><span class="label bg-success" style="line-height: 20px;"><i class="glyphicon glyphicon-edit" style="font-size: 12px;" data-toggle="tooltip" title="Edit Subscription Details" data-placement="bottom"></i></span></a></li>
                                                </ul>
                                                </td>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header bg-info" style="background-color:#009FDF;">
            ...
            <h6 class="modal-title">Edit Subscription Details</h6>
          </div>

          <div class="modal-body">
              <div id="periodchange_model_data">
