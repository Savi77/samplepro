...
<!--============================ Date picker adjustment ================================ -->
  ...
  <style type="text/css">
      ...
      .dataTables_filter 
      {
          margin: 2px 22px 20px 20px !important;
      }
                        ...
                        <div class="panel-body" style="padding:0px;">
                          <div class="tabbable">
                            <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#009FDF;">
                              <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab">Issue List<i class="icon-menu7 position-right"></i></a></li>
                            </ul>
...
<!--========================== Date picker javascript ====================================-->
     <!--  <script type="text/javascript">
          $(function () 
          {
              $('#schedule_date').datetimepicker({format: 'DD MMMM, YYYY',minDate: 0, useCurrent: true});
          });
      </script> -->
       <script type="text/javascript">
