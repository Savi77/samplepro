    ...
    <div class="page-header">
        <div class="breadcrumb-line breadcrumb-line-wide">
            <ul class="breadcrumb">
                ...
                <li class="active">Refund Cancellation Policy</li>
            </ul>
        </div>
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Refund Cancellation Policy</span> - Manage</h4>
            </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Refund Cancellation Policy</h5>   
                    </div>
                    <hr style="margin: 0;">
                    <?php if (!empty($Refund_Cancellation_Policy)) { ?>
                        <form class="form-horizontal" id="UpdatePrivacyPolicyFrom" style="padding: 5px 30px;" method="POST">
                            <input type="hidden" name="policies_type" value="<?= $Refund_Cancellation_Policy->policies_type?>">
                            <input type="hidden" name="policies_id" value="<?= $Refund_Cancellation_Policy->policies_id?>">
                            <div class="form-group" style="padding-top: 20px;">
                                <div class="col-sm-12">
                                    <textarea name="description" id="description" rows="4" cols="4" required> <?= $Refund_Cancellation_Policy->policies_section?> </textarea>
                                </div>
                            </div>
                    ...
                    <?php   }else { ?>
                        <form class="form-horizontal" id="AddPrivacyPolicyFrom" style="padding: 5px 30px;" method="POST">
                            <input type="hidden" name="type" value="Refund_Cancellation">
                            <div class="form-group" style="padding-top: 20px;">
                                <div class="col-sm-12">
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            new PNotify({
                                ...
                                text: 'Update Refund Cancellation Policy Successfully!',
                                type: 'success',
                                width: '350px',
                            ...
                            setTimeout(function() {
                                window.location = "<?php echo base_url('BA/Policies/Refund_Cancellation_Policy'); ?>";
                            }, 1000);
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            new PNotify({
                                title: 'Add Policies',
                                text: 'Add Refund Cancellation Policy Successfully!',
                                type: 'success',
                                width: '350px',
                                addclass: 'pnotify-center'
