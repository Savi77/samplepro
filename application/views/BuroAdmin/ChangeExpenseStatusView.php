                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                  Approved Amount : <sup style="color: red;">*</sup>
                                    <input type="text" class="form-control" name="AdminApprovedAmount"  value="<?= $key->AdminApprovedAmount;?>"  placeholder="Enter Amount"  onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 43 || event.charCode == 45' maxlength="15"  autocomplete="off">                      
                                </div>
                            </div>
                           <?php } ?> 
                         </div>  
