...
<body style="overflow-x: hidden;">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <a href="<?php echo base_url('admin/Dashboard/view_dashboard'); ?>"> <span class="text-semibold">Home</span></a> - Currency
                </h4>
            </div>
                                    ...
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs nav-tabs-bottom" style="background-color:#00619F;">
                                            <li class="active" style="font-size: 18px;"><a href="#right-icon-tab1" data-toggle="tab" style="color: white;">
                                                    <i class="icon-paste3 position-right" style="zoom:1.4;"></i> &nbsp; Currency</a></li>
                                        </ul>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <ul class="icons-list">
                                                                        <li><a data-toggle="modal" onclick="EditDetails(id)" id="<?= $row->currency_id; ?>">
                                                                        ...
                                                                        <li><a data-toggle="modal" onclick="DeleteDetails(id)" id="<?= $row->currency_id; ?>"><span class="label bg-danger" style="line-height: 20px;"><i class="glyphicon glyphicon-trash" style="font-size: 12px;" data-toggle="tooltip" title="Delete" data-placement="bottom"></i></span></a></li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                                                        <?php $count++;
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Currency : <sup style="color: red">*</sup></label>
                                                <input type="text" class="form-control" name="country">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Currency Sign : <sup style="color: red">*</sup></label>
                                                <input type="text" class="form-control" name="currency_sign" placeholder="E.g. INR">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
        ...
        $(document).ready(function(e) {
            $("#addform").on('submit', (function(e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('BA/Currency/addDetails'); ?>",
                        type: "POST",
    ...
    <script>
        function EditDetails(privilege_id) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('BA/Currency/EditDetails'); ?>",
                cache: false,
                data: datastring,
                success: function(data) {
                    // alert(data);
    ...
    <script type="text/javascript">
        function DeleteDetails(privilege_id) {
            var notice = new PNotify({
                title: 'Confirmation',
                text: '<p>Are you sure you want to delete this Currency ?</p>',
                hide: false,
                type: 'warning',
                confirm: {
                    confirm: true,
            ...
            notice.get().on('pnotify.confirm', function() {
                var datastring = 'privilege_id=' + privilege_id;
                $.ajax({
                    url: '<?php echo base_url('BA/Currency/DeleteDetails') ?>',
                    type: "POST",
                    data: datastring,
                    success: function(data) {
                        new PNotify({
