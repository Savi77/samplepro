...
<body class="vertical-layout vertical-menu-modern 1-column  bg-full-screen-image sty blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" style="overflow-y:hidden;">
	<!-- BEGIN: Content-->
	<div class="app-content content">
				...
				<section class="flexbox-container">
					<div class="col-12 d-flex">
						<div class="col-lg-4 col-md-8 adminLogin">
							<div class="card border-grey border-lighten-3 m-0 col-11 box-shadow-2 p-0">
								...
								<div class="card-content">
									<p class="card-subtitle line-on-side text-muted text-center font-medium-1 mx-2 my-1"><span> Sign In </span></p>
										...
										<form class="form-horizontal" id="LoginForm">
											...
											<fieldset class="form-group position-relative has-icon-left">
												<div class="shbtn" id="show_hide_password_user" style="display: flex;">
													<input type="password" class="form-control" name="password" placeholder="Enter Password" autocomplete="off" style="border-right: 0px;">
									...
									<div class="card-footer text-right">
										<a href="<?= base_url('SignIn/recovery_pass');?>">Forgot password?</a>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="navbar navbar-inverse">			
			<div class="footer text-muted" style="color: white !important;">
				Copyright ©<?php echo date("Y"); ?>, Buroforce | All right reserved.
			</div>
			<div class="footer text-muted">
				<!-- <a href="http://www.ileaf.in" target="_blank" style="color: white !important;">Powered By iLEAF Information Technology Pvt Ltd.&nbsp;&nbsp;</a> -->
			</div>
		</div>
	</div>
	<!-- END: Content-->
