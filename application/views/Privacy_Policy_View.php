...
<section class="services-section">
    ...
    <div class="tab" style="background-color: #f3f3f3;">
        <button class="tablinks    active" onclick="openCity(event, '1')" style="margin-top: 29px;font-size: 18px">Privacy Policy</button>
        <button class="tablinks   " onclick="openCity(event, '2') " style="font-size: 18px">Terms Of Service</button>
        <button class="tablinks  " onclick="openCity(event, '3') " style="    font-size: 18px">Refund & Cancellation Policy</button>
    </div>
