	...
	public function index()
	{
		...
		switch ($tag) {
			...
			case "login":
				...
				$this->Webservices_model->check_login($mobileno, $password, $user_type, $email);
				break;
			...
			case "business_segment_list":
				// get a list for business segment
			...
			case "submit_billing_info":
				...
				$this->Webservices_model->submit_billing_info($token_id, $employee_id, $billing_type, $billing_remark, $target, $price, $billing_amount);
				break;
			...
			case "Lead_Opportunity_by_Source_Details":
				$this->Webservices_Report_model->Lead_Opportunity_by_Source_Details();
				break;
			...
			case "Lead_Opportunity_by_Sales_Details":
				$this->Webservices_Report_model->Lead_Opportunity_by_Sales_Details();
				break;
			...
			case "Lead_Opportunity_by_Stage_Details":
				$this->Webservices_Report_model->Lead_Opportunity_by_Stage_Details();
				break;


			case "LocationWiseContacts":
				$this->Webservices_Report_model->LocationWiseContacts();
				break;

			case "LocationWiseContactsDetails":
				$this->Webservices_Report_model->LocationWiseContactsDetails();
				break;

			case "TypeWiseContacts":
				$this->Webservices_Report_model->TypeWiseContacts();
				break;

			case "TypeWiseContactsDetails":
				$this->Webservices_Report_model->TypeWiseContactsDetails();
				break;

			case "EmployeeAvailableTimeSlots":
				$this->Webservices_Report_model->EmployeeAvailableTimeSlots();
				break;

			case "TargetType":
				$this->Webservices_Report_model->GetTargetType();
				break;

			case "EmployeeTargetList":
				$this->Webservices_Report_model->EmployeeTargetList();
				break;

			case "LeadOppMonthlyCount":
				$this->Webservices_Report_model->LeadOppMonthlyCount();
				break;

			case "LeadOppMonthlyCountDetails":
				$this->Webservices_Report_model->LeadOppMonthlyCountDetails();
				break;

			case "ContactFilter":
				$this->Webservices_Report_model->ContactFilter();
				break;

			case "ContactSummary":
				$this->Webservices_Report_model->ContactSummary();
				break;

			case "ContactSummaryDetails":
				$this->Webservices_Report_model->ContactSummaryDetails();
				break;
			...
			case "LeadOppSalesPersonProductwise":
				$this->Webservices_Report_model->LeadOppSalesPersonProductwise();
				break;

			case "LeadOppSalesPersonProductwiseDetails":
				$this->Webservices_Report_model->LeadOppSalesPersonProductwiseDetails();
				break;

			case "LeadOppSalesPersonSegment":
				$this->Webservices_Report_model->LeadOppSalesPersonSegment();
				break;

			case "LeadOppSalesPersonSegmentDetails":
				$this->Webservices_Report_model->LeadOppSalesPersonSegmentDetails();
				break;


			case "PermissionArray":
				$this->Webservices_Report_model->PermissionArray();
				break;

			case "UserPermission":
				$this->Webservices_Report_model->UserPermission();
				break;
			case "near_by_customer":
				$org_id = $_REQUEST['org_id'];
				$emp_id = $_REQUEST['emp_id'];
				$this->Webservices_model->near_by_customer($org_id, $emp_id);
				break;
				//End Reports ---------------------------------------------- 
