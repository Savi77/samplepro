...
class LeadOppSalesPersonProductwiseDetails_report extends REST_Controller 
{
    ...
    public function index_post()
    {
        ...
        if(!empty($final_array))
        {
            $responce = array(
                'status'=>200,
                'msg' =>'Lead Opportunity Sales Person Productwise Details Data Fetched Successfully',
                'data' => $final_array
                );
        }
        else
