...
class Lead_Opportunity_by_Source_Details extends REST_Controller 
{
    ...
    public function index_post()
    {
        ...
        {  
            ...
            $source_data=$this->db->get("tbl_source")->row();
                ...
                $new_array=array(
                                ...
                                'Excepted_Revenue'=> $row->project_business_value
        ...
        if(!empty($final_array))
        {
            $responce = array(
                'status'=>200,
                'msg' =>'Lead Opportunity By Source Details Data Fetched Successfully',
                'data' => $final_array
                );
        }
        else
